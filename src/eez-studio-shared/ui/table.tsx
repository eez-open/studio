...
const StyledTable = styled.table`
    ...
    th.sort-enabled {
        ...
        background-image: url("../eez-studio-shared/_images/col_sort_enabled.png");
        padding-left: 20px;
        cursor: pointer;
    }

    th.sort-asc {
        background-image: url("../eez-studio-shared/_images/col_sort_asc.png");
    }

    th.sort-desc {
        background-image: url("../eez-studio-shared/_images/col_sort_desc.png");
    }
`;
