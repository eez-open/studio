...
import { watch, sendMessage, registerSource } from "shared/notify";
import { isRenderer } from "shared/util";
import { _each, _extend, _keys, _map, _pickBy } from "shared/algorithm";
...
export const types = {
    ...
    foreign: {
        fromDB: (value: any) => value.toString(),
