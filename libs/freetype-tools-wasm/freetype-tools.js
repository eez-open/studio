...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'freetype-tools.wast';
  var wasmBinaryFile = 'freetype-tools.wasm';
  var asmjsCodeFile = 'freetype-tools.temp.asm.js';
...
var ASM_CONSTS = [function($0, $1) { FS.mkdir("/fonts" + $0); FS.mount(NODEFS, { root: Pointer_stringify($1) }, "/fonts" + $0); },
 function($0) { FS.unmount("/fonts" + $0); FS.rmdir("/fonts" + $0); }];
...
Module['wasmTableSize'] = 7168;

Module['wasmMaxTableSize'] = 7168;
...
var real__create_font_extract_state = asm["_create_font_extract_state"]; asm["_create_font_extract_state"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__create_font_extract_state.apply(null, arguments);
};

var real__extract_glyph = asm["_extract_glyph"]; asm["_extract_glyph"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__extract_glyph.apply(null, arguments);
};
...
var real__free_font_extract_state = asm["_free_font_extract_state"]; asm["_free_font_extract_state"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__free_font_extract_state.apply(null, arguments);
};
...
var _create_font_extract_state = Module["_create_font_extract_state"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_create_font_extract_state"].apply(null, arguments) };
var _extract_glyph = Module["_extract_glyph"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_extract_glyph"].apply(null, arguments) };
...
var _free_font_extract_state = Module["_free_font_extract_state"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_free_font_extract_state"].apply(null, arguments) };
