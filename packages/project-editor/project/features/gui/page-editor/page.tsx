...
import { TreeObjectAdapter, ITreeObjectAdapter } from "project-editor/model/objectAdapter";
...
import {
    getPageContext,
    IDataContext
} from "project-editor/project/features/gui/page-editor/page-context";
import { WidgetContainerComponent } from "project-editor/project/features/gui/page-editor/render";
import {
    IResizing,
    resizingProperty
} from "project-editor/project/features/gui/page-editor/resizing-widget-property";
import { withResolutionDependableProperties } from "project-editor/project/features/gui/page-editor/resolution-dependable-properties";
...
export class Page extends EezObject {
    ...
    styleHook(style: React.CSSProperties, designerContext: IDesignerContext | undefined) {
        ...
        if (this.style) {
            ...
            if (pageStyle) {
                style.backgroundColor = getPageContext().getThemedColor(pageStyle.backgroundColor);
            }
        }
    }
