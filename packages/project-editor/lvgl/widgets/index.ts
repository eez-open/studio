...
registerLvglEnum(LV_STATE_ENUM_NAME, 
    ...
    ["8.4.0", "9.2.2", "9.3.0", "9.4.0"]
);

registerLvglEnum(LV_STATE_ENUM_NAME, 
    {
        DEFAULT: LVGL_STATE_CODES_MORE_V9_5_0.DEFAULT,
        CHECKED: LVGL_STATE_CODES_V9_5_0.CHECKED,
        FOCUSED: LVGL_STATE_CODES_V9_5_0.FOCUSED,
        FOCUS_KEY: LVGL_STATE_CODES_V9_5_0.FOCUS_KEY,
        EDITED: LVGL_STATE_CODES_MORE_V9_5_0.EDITED,
        HOVERED: LVGL_STATE_CODES_MORE_V9_5_0.HOVERED,
        PRESSED: LVGL_STATE_CODES_V9_5_0.PRESSED,
        SCROLLED: LVGL_STATE_CODES_MORE_V9_5_0.SCROLLED,
        DISABLED: LVGL_STATE_CODES_V9_5_0.DISABLED,
        USER1: LVGL_STATE_CODES_MORE_V9_5_0.USER1,
        USER2: LVGL_STATE_CODES_MORE_V9_5_0.USER2,
