    ...
    static classInfo = makeDerivedClassInfo(LVGLWidget.classInfo, {
        ...
        icon: (
            <svg viewBox="0 0 24 24">
                <path d="M3 18h4.382l-1.277 2.553a1 1 0 0 0 1.79.894L9.618 18H11v2a1 1 0 0 0 2 0v-2h1.382l1.723 3.447a1 1 0 1 0 1.79-.894L16.618 18H21a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1h-8V3a1 1 0 0 0-2 0v1H3a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1M4 6h16v10H4Z" />
            </svg>
        ),
