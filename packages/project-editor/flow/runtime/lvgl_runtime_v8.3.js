...
var ASM_CONSTS = {
  968704: ($0) => { startToDebuggerMessage($0); },  
 968736: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 968811: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 968886: ($0) => { finishToDebuggerMessage($0); },  
 968919: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 968972: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 969078: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 969114: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 969151: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 969191: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 969248: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 969307: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
