...
enum StylesEnum {
    ...
    STYLE_ID_BACKGROUND = 10,
    STYLE_ID_SELECT_ENUM_ITEM_POPUP_DISABLED_ITEM_S = 11,
    STYLE_ID_MENU_WITH_BUTTONS_MESSAGE = 12,
    STYLE_ID_FPS_GRAPH = 13,
    STYLE_ID_MENU_WITH_BUTTONS_CONTAINER = 14,
    STYLE_ID_MENU_WITH_BUTTONS_BUTTON = 15,
    STYLE_ID_BUTTON = 16,
    STYLE_ID_BUTTON_DISABLED = 17,
    STYLE_ID_TOUCH_CALIBRATION = 18,
    STYLE_ID_NOTE_M = 19,
    STYLE_ID_TOUCH_CALIBRATION_POINT = 20,
    STYLE_ID_INLINE20 = 21
};
...
enum ColorsEnum {
    ...
    COLOR_ID_TEXT = 1,
    COLOR_ID_TEXT_INACTIVE = 2,
    COLOR_ID_DARK_TEXT = 3,
    COLOR_ID_BORDER = 4,
    COLOR_ID_BACKDROP = 5,
	...
	COLOR_ID_CUSTOM_OPUP_BACKGROUND_WARNING = 33,
	COLOR_ID_CUSTOM_OPUP_BACKGROUND_INFO = 34,
	COLOR_ID_CUSTOM_EXT_REGULAR = 35,
	COLOR_ID_CUSTOM_000000 = 36,
	COLOR_ID_CUSTOM_00FF1E = 37,
	COLOR_ID_CUSTOM_CTION_COLOR = 38,
	COLOR_ID_CUSTOM_FFFFFF = 39,
	COLOR_ID_CUSTOM_00FF00 = 40
};
...
extern const uint8_t assets[10114];
