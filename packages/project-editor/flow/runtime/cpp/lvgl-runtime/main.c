...
void lv_example_get_started_1(void)
{
    ...
    lv_label_set_text(label2, "Trt");                     /*Set the labels text*/
...
void lv_example_style_15(void)
{
    ...
    lv_obj_set_style_translate_x(btn, 50, 0);
    lv_obj_set_style_translate_y(btn, 20, 0);
    lv_obj_set_style_opa(btn, LV_OPA_50, 0);
    lv_obj_align(btn, LV_ALIGN_CENTER, 0, 70);
...
static void hal_init(void)
{
   /* Use the 'sdl' driver which creates window on PC's monitor to simulate a display*/
    ...
    lv_color_t * buf1_1 = malloc(sizeof(lv_color_t) * sdl_hor_res * sdl_ver_res);
