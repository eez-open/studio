...
var INITIAL_MEMORY = Module['INITIAL_MEMORY'] || 8388608;legacyModuleProp('INITIAL_MEMORY', 'INITIAL_MEMORY');
...
assert(INITIAL_MEMORY == 8388608, 'Detected runtime INITIAL_MEMORY setting.  Use -sIMPORTED_MEMORY to define wasmMemory dynamically');
...
var ASM_CONSTS = {
  48772: ($0, $1, $2, $3, $4, $5, $6) => { executeScpi($0, $1, new Uint8Array(Module.HEAPU8.buffer, $2, $3), $4, $5, $6); },  
 48855: () => { FS.mkdir("/min_eez_sample"); FS.mount(IDBFS, {}, "/min_eez_sample"); Module.syncdone = 0; FS.syncfs(true, function(err) { assert(!err); Module.syncdone = 1; }); },  
 49016: ($0) => { startToDebuggerMessage($0); },  
 49048: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 49123: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 49198: ($0) => { finishToDebuggerMessage($0); },  
 49231: () => { if (Module.syncdone) { Module.syncdone = 0; FS.syncfs(false, function(err) { assert(!err); Module.syncdone = 1; }); } },  
 49349: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 49455: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 49491: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 49528: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 49568: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 49625: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 49684: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); },  
 49757: ($0, $1, $2, $3) => { executeDashboardComponent($0, $1, $2, $3); },  
 49804: ($0, $1, $2) => { return operationJsonGet($0, $1, UTF8ToString($2)); },  
 49859: ($0, $1, $2, $3) => { return operationJsonSet($0, $1, UTF8ToString($2), $3); },  
 49918: ($0, $1) => { return operationJsonArrayLength($0, $1); },  
 49963: ($0, $1, $2, $3) => { return operationJsonArraySlice($0, $1, $2, $3); },  
 50015: ($0, $1, $2) => { return operationJsonArrayAppend($0, $1, $2); },  
 50064: ($0, $1, $2, $3) => { return operationJsonArrayInsert($0, $1, $2, $3); },  
 50117: ($0, $1, $2) => { return operationJsonArrayRemove($0, $1, $2); },  
 50166: ($0, $1) => { return operationJsonClone($0, $1); },  
 50205: ($0) => { return operationJsonMake($0); },  
 50239: ($0, $1, $2) => { return convertFromJson($0, $1, $2); },  
 50279: ($0, $1) => { return convertToJson($0, $1); },  
 50313: ($0, $1) => { dashboardObjectValueIncRef($0, $1); },  
 50353: ($0, $1) => { dashboardObjectValueDecRef($0, $1); },  
 50393: ($0, $1) => { onObjectArrayValueFree($0, $1); },  
 50429: ($0, $1) => { return getBitmapAsDataURL($0, UTF8ToString($1)); },  
 50482: ($0, $1) => { freeComponentExecutionState($0, $1); }
};
