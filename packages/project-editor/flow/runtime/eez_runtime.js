...
function createWasm() {
  ...
  function receiveInstance(instance, module) {
    ...
    //assert(wasmMemory.buffer.byteLength === 8388608);
    updateMemoryViews();
...
var ASM_CONSTS = {
  48916: ($0, $1, $2, $3, $4, $5, $6) => { executeScpi($0, $1, new Uint8Array(Module.HEAPU8.buffer, $2, $3), $4, $5, $6); },  
 48999: () => { FS.mkdir("/min_eez_sample"); FS.mount(IDBFS, {}, "/min_eez_sample"); Module.syncdone = 0; FS.syncfs(true, function(err) { assert(!err); Module.syncdone = 1; }); },  
 49160: ($0) => { startToDebuggerMessage($0); },  
 49192: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 49267: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 49342: ($0) => { finishToDebuggerMessage($0); },  
 49375: () => { if (Module.syncdone) { Module.syncdone = 0; FS.syncfs(false, function(err) { assert(!err); Module.syncdone = 1; }); } },  
 49493: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 49599: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 49635: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 49672: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 49712: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 49769: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 49828: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); },  
 49901: ($0, $1, $2, $3) => { executeDashboardComponent($0, $1, $2, $3); },  
 49948: ($0, $1, $2) => { return operationJsonGet($0, $1, UTF8ToString($2)); },  
 50003: ($0, $1, $2, $3) => { return operationJsonSet($0, $1, UTF8ToString($2), $3); },  
 50062: ($0, $1) => { return operationJsonArrayLength($0, $1); },  
 50107: ($0, $1, $2, $3) => { return operationJsonArraySlice($0, $1, $2, $3); },  
 50159: ($0, $1, $2) => { return operationJsonArrayAppend($0, $1, $2); },  
 50208: ($0, $1, $2, $3) => { return operationJsonArrayInsert($0, $1, $2, $3); },  
 50261: ($0, $1, $2) => { return operationJsonArrayRemove($0, $1, $2); },  
 50310: ($0, $1) => { return operationJsonClone($0, $1); },  
 50349: ($0) => { return operationJsonMake($0); },  
 50383: ($0, $1, $2) => { return operationStringFormat($0, UTF8ToString($1), $2); },  
 50443: ($0, $1, $2) => { return convertFromJson($0, $1, $2); },  
 50483: ($0, $1) => { return convertToJson($0, $1); },  
 50517: ($0, $1) => { dashboardObjectValueIncRef($0, $1); },  
 50557: ($0, $1) => { dashboardObjectValueDecRef($0, $1); },  
 50597: ($0, $1) => { onObjectArrayValueFree($0, $1); },  
 50633: ($0, $1) => { return getBitmapAsDataURL($0, UTF8ToString($1)); },  
 50686: ($0, $1) => { freeComponentExecutionState($0, $1); }
};
...
var _createJsonValue = Module['_createJsonValue'] = createExportWrapper('createJsonValue');
var _createErrorValue = Module['_createErrorValue'] = createExportWrapper('createErrorValue');
