...
var ASM_CONSTS = {
  58760: ($0, $1) => { freeComponentExecutionState($0, $1); },  
 58801: ($0, $1, $2, $3, $4) => { executeScpi($0, $1, new Uint8Array(Module.HEAPU8.buffer, $2, $3), $4); },  
 58876: () => { FS.mkdir("/min_eez_sample"); FS.mount(IDBFS, {}, "/min_eez_sample"); Module.syncdone = 0; FS.syncfs(true, function(err) { assert(!err); Module.syncdone = 1; }); },  
 59037: ($0) => { startToDebuggerMessage($0); },  
 59069: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 59144: ($0) => { finishToDebuggerMessage($0); },  
 59177: ($0, $1, $2, $3) => { executeDashboardComponent($0, $1, $2, $3); },  
 59224: ($0, $1) => { onArrayValueFree($0, $1); },  
 59254: () => { if (Module.syncdone) { Module.syncdone = 0; FS.syncfs(false, function(err) { assert(!err); Module.syncdone = 1; }); } }
};
