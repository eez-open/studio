...
var ASM_CONSTS = {
  963680: ($0) => { startToDebuggerMessage($0); },  
 963712: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 963787: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 963862: ($0) => { finishToDebuggerMessage($0); },  
 963895: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 963948: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 964054: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 964090: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 964127: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 964167: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 964224: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 964283: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
