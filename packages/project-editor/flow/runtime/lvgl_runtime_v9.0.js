...
var ASM_CONSTS = {
  1031240: ($0) => { startToDebuggerMessage($0); },  
 1031272: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1031347: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1031422: ($0) => { finishToDebuggerMessage($0); },  
 1031455: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1031508: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1031541: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1031577: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1031683: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1031719: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1031756: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1031796: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1031853: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1031912: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
