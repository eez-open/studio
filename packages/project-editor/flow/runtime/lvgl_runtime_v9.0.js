...
var wasmBinaryFile;
  wasmBinaryFile = 'lvgl_runtime_v9.0.wasm';
...
var ASM_CONSTS = {
  1040912: ($0) => { startToDebuggerMessage($0); },  
 1040944: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1041019: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1041094: ($0) => { finishToDebuggerMessage($0); },  
 1041127: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1041157: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1041187: ($0) => { lvglScreenTick($0); },  
 1041211: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1041251: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1041305: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1041359: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1041412: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1041465: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1041518: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1041551: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1041587: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1041632: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1041738: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1041774: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1041811: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1041851: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1041908: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1041967: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
...
var _lv_display_flush_ready = Module['_lv_display_flush_ready'] = createExportWrapper('lv_display_flush_ready');
var _lv_area_get_width = Module['_lv_area_get_width'] = createExportWrapper('lv_area_get_width');
var _lv_malloc = Module['_lv_malloc'] = createExportWrapper('lv_malloc');
var _lv_free = Module['_lv_free'] = createExportWrapper('lv_free');
...
var _lv_display_create = Module['_lv_display_create'] = createExportWrapper('lv_display_create');
var _lv_display_set_flush_cb = Module['_lv_display_set_flush_cb'] = createExportWrapper('lv_display_set_flush_cb');
var _lv_display_set_buffers = Module['_lv_display_set_buffers'] = createExportWrapper('lv_display_set_buffers');
var _lv_indev_create = Module['_lv_indev_create'] = createExportWrapper('lv_indev_create');
var _lv_indev_set_type = Module['_lv_indev_set_type'] = createExportWrapper('lv_indev_set_type');
var _lv_indev_set_read_cb = Module['_lv_indev_set_read_cb'] = createExportWrapper('lv_indev_set_read_cb');
...
var _lv_display_get_default = Module['_lv_display_get_default'] = createExportWrapper('lv_display_get_default');
...
var _lv_display_set_theme = Module['_lv_display_set_theme'] = createExportWrapper('lv_display_set_theme');
var _mainLoop = Module['_mainLoop'] = createExportWrapper('mainLoop');
var _lv_tick_inc = Module['_lv_tick_inc'] = createExportWrapper('lv_tick_inc');
...
var _lv_button_create = Module['_lv_button_create'] = createExportWrapper('lv_button_create');
var _lv_image_create = Module['_lv_image_create'] = createExportWrapper('lv_image_create');
...
var _lv_scale_create = Module['_lv_scale_create'] = createExportWrapper('lv_scale_create');
...
var _lv_event_get_target_obj = Module['_lv_event_get_target_obj'] = createExportWrapper('lv_event_get_target_obj');
...
var _lv_obj_remove_state = Module['_lv_obj_remove_state'] = createExportWrapper('lv_obj_remove_state');
var _lv_obj_add_flag = Module['_lv_obj_add_flag'] = createExportWrapper('lv_obj_add_flag');
var _lv_obj_remove_flag = Module['_lv_obj_remove_flag'] = createExportWrapper('lv_obj_remove_flag');
...
var _lv_screen_load_anim = Module['_lv_screen_load_anim'] = createExportWrapper('lv_screen_load_anim');
var _lvglDeleteObject = Module['_lvglDeleteObject'] = createExportWrapper('lvglDeleteObject');
var _lv_screen_active = Module['_lv_screen_active'] = createExportWrapper('lv_screen_active');
var _lv_screen_load = Module['_lv_screen_load'] = createExportWrapper('lv_screen_load');
var _lv_obj_delete = Module['_lv_obj_delete'] = createExportWrapper('lv_obj_delete');
...
var _lv_color_hex = Module['_lv_color_hex'] = createExportWrapper('lv_color_hex');
...
var _lv_binfont_create = Module['_lv_binfont_create'] = createExportWrapper('lv_binfont_create');
var _lvglFreeFont = Module['_lvglFreeFont'] = createExportWrapper('lvglFreeFont');
var _lv_binfont_destroy = Module['_lv_binfont_destroy'] = createExportWrapper('lv_binfont_destroy');
...
var _lv_color_to_u32 = Module['_lv_color_to_u32'] = createExportWrapper('lv_color_to_u32');
...
var _lv_ll_clear = Module['_lv_ll_clear'] = createExportWrapper('lv_ll_clear');
var _lv_ll_ins_head = Module['_lv_ll_ins_head'] = createExportWrapper('lv_ll_ins_head');
var _lv_log_add = Module['_lv_log_add'] = createExportWrapper('lv_log_add');
var _lv_group_delete = Module['_lv_group_delete'] = createExportWrapper('lv_group_delete');
...
var _lv_indev_get_group = Module['_lv_indev_get_group'] = createExportWrapper('lv_indev_get_group');
var _lv_obj_send_event = Module['_lv_obj_send_event'] = createExportWrapper('lv_obj_send_event');
var _lv_ll_get_head = Module['_lv_ll_get_head'] = createExportWrapper('lv_ll_get_head');
var _lv_ll_get_next = Module['_lv_ll_get_next'] = createExportWrapper('lv_ll_get_next');
var _lv_ll_remove = Module['_lv_ll_remove'] = createExportWrapper('lv_ll_remove');
...
var _lv_ll_ins_tail = Module['_lv_ll_ins_tail'] = createExportWrapper('lv_ll_ins_tail');
var _lv_ll_get_tail = Module['_lv_ll_get_tail'] = createExportWrapper('lv_ll_get_tail');
var _lv_ll_get_prev = Module['_lv_ll_get_prev'] = createExportWrapper('lv_ll_get_prev');
...
var _lv_ll_get_len = Module['_lv_ll_get_len'] = createExportWrapper('lv_ll_get_len');
var _lv_group_get_obj_by_index = Module['_lv_group_get_obj_by_index'] = createExportWrapper('lv_group_get_obj_by_index');
var _lv_group_get_count = Module['_lv_group_get_count'] = createExportWrapper('lv_group_get_count');
var _lv_group_by_index = Module['_lv_group_by_index'] = createExportWrapper('lv_group_by_index');
...
var _lv_event_mark_deleted = Module['_lv_event_mark_deleted'] = createExportWrapper('lv_event_mark_deleted');
var _lv_obj_enable_style_refresh = Module['_lv_obj_enable_style_refresh'] = createExportWrapper('lv_obj_enable_style_refresh');
var _lv_obj_remove_style_all = Module['_lv_obj_remove_style_all'] = createExportWrapper('lv_obj_remove_style_all');
var _lv_anim_delete = Module['_lv_anim_delete'] = createExportWrapper('lv_anim_delete');
var _lv_event_remove_all = Module['_lv_event_remove_all'] = createExportWrapper('lv_event_remove_all');
...
var _lv_obj_get_child_count = Module['_lv_obj_get_child_count'] = createExportWrapper('lv_obj_get_child_count');
...
var _lv_indev_active = Module['_lv_indev_active'] = createExportWrapper('lv_indev_active');
...
var _lv_area_is_in = Module['_lv_area_is_in'] = createExportWrapper('lv_area_is_in');
var _lv_event_get_layer = Module['_lv_event_get_layer'] = createExportWrapper('lv_event_get_layer');
...
var _lv_obj_update_flag = Module['_lv_obj_update_flag'] = createExportWrapper('lv_obj_update_flag');
var _lv_obj_style_state_compare = Module['_lv_obj_style_state_compare'] = createExportWrapper('lv_obj_style_state_compare');
var _lv_obj_update_layer_type = Module['_lv_obj_update_layer_type'] = createExportWrapper('lv_obj_update_layer_type');
var _lv_malloc_zeroed = Module['_lv_malloc_zeroed'] = createExportWrapper('lv_malloc_zeroed');
var _lv_obj_style_create_transition = Module['_lv_obj_style_create_transition'] = createExportWrapper('lv_obj_style_create_transition');
...
var _lv_obj_set_state = Module['_lv_obj_set_state'] = createExportWrapper('lv_obj_set_state');
...
var _lv_display_get_next = Module['_lv_display_get_next'] = createExportWrapper('lv_display_get_next');
var _lv_obj_null_on_delete = Module['_lv_obj_null_on_delete'] = createExportWrapper('lv_obj_null_on_delete');
var _lv_obj_set_user_data = Module['_lv_obj_set_user_data'] = createExportWrapper('lv_obj_set_user_data');
var _lv_obj_get_user_data = Module['_lv_obj_get_user_data'] = createExportWrapper('lv_obj_get_user_data');
var _lv_realloc = Module['_lv_realloc'] = createExportWrapper('lv_realloc');
var _lv_display_get_horizontal_resolution = Module['_lv_display_get_horizontal_resolution'] = createExportWrapper('lv_display_get_horizontal_resolution');
var _lv_display_get_vertical_resolution = Module['_lv_display_get_vertical_resolution'] = createExportWrapper('lv_display_get_vertical_resolution');
...
var _lv_obj_destruct = Module['_lv_obj_destruct'] = createExportWrapper('lv_obj_destruct');
var _lv_obj_style_apply_color_filter = Module['_lv_obj_style_apply_color_filter'] = createExportWrapper('lv_obj_style_apply_color_filter');
var _lv_memcpy = Module['_lv_memcpy'] = createExportWrapper('lv_memcpy');
var _lv_image_src_get_type = Module['_lv_image_src_get_type'] = createExportWrapper('lv_image_src_get_type');
var _lv_obj_init_draw_label_dsc = Module['_lv_obj_init_draw_label_dsc'] = createExportWrapper('lv_obj_init_draw_label_dsc');
var _lv_obj_init_draw_image_dsc = Module['_lv_obj_init_draw_image_dsc'] = createExportWrapper('lv_obj_init_draw_image_dsc');
var _lv_area_get_height = Module['_lv_area_get_height'] = createExportWrapper('lv_area_get_height');
...
var _lv_obj_get_ext_draw_size = Module['_lv_obj_get_ext_draw_size'] = createExportWrapper('lv_obj_get_ext_draw_size');
var _lv_obj_get_layer_type = Module['_lv_obj_get_layer_type'] = createExportWrapper('lv_obj_get_layer_type');
var _lv_event_push = Module['_lv_event_push'] = createExportWrapper('lv_event_push');
var _lv_event_send = Module['_lv_event_send'] = createExportWrapper('lv_event_send');
var _lv_event_pop = Module['_lv_event_pop'] = createExportWrapper('lv_event_pop');
var _lv_obj_event_base = Module['_lv_obj_event_base'] = createExportWrapper('lv_obj_event_base');
var _lv_event_add = Module['_lv_event_add'] = createExportWrapper('lv_event_add');
var _lv_obj_get_event_count = Module['_lv_obj_get_event_count'] = createExportWrapper('lv_obj_get_event_count');
var _lv_event_get_count = Module['_lv_event_get_count'] = createExportWrapper('lv_event_get_count');
var _lv_obj_get_event_dsc = Module['_lv_obj_get_event_dsc'] = createExportWrapper('lv_obj_get_event_dsc');
var _lv_event_get_dsc = Module['_lv_event_get_dsc'] = createExportWrapper('lv_event_get_dsc');
var _lv_obj_remove_event = Module['_lv_obj_remove_event'] = createExportWrapper('lv_obj_remove_event');
var _lv_event_remove = Module['_lv_event_remove'] = createExportWrapper('lv_event_remove');
...
var _lv_event_remove_dsc = Module['_lv_event_remove_dsc'] = createExportWrapper('lv_event_remove_dsc');
...
var _lv_event_get_current_target_obj = Module['_lv_event_get_current_target_obj'] = createExportWrapper('lv_event_get_current_target_obj');
...
var _lv_event_get_rotary_diff = Module['_lv_event_get_rotary_diff'] = createExportWrapper('lv_event_get_rotary_diff');
...
var _lv_event_get_draw_task = Module['_lv_event_get_draw_task'] = createExportWrapper('lv_event_get_draw_task');
...
var _lv_obj_get_display = Module['_lv_obj_get_display'] = createExportWrapper('lv_obj_get_display');
var _lv_display_send_event = Module['_lv_display_send_event'] = createExportWrapper('lv_display_send_event');
var _lv_obj_refr_pos = Module['_lv_obj_refr_pos'] = createExportWrapper('lv_obj_refr_pos');
var _lv_layout_apply = Module['_lv_layout_apply'] = createExportWrapper('lv_layout_apply');
...
var _lv_obj_transform_point_array = Module['_lv_obj_transform_point_array'] = createExportWrapper('lv_obj_transform_point_array');
var _lv_point_array_transform = Module['_lv_point_array_transform'] = createExportWrapper('lv_point_array_transform');
var _lv_obj_get_transformed_area = Module['_lv_obj_get_transformed_area'] = createExportWrapper('lv_obj_get_transformed_area');
var _lv_display_is_invalidation_enabled = Module['_lv_display_is_invalidation_enabled'] = createExportWrapper('lv_display_is_invalidation_enabled');
var _lv_obj_area_is_visible = Module['_lv_obj_area_is_visible'] = createExportWrapper('lv_obj_area_is_visible');
var _lv_inv_area = Module['_lv_inv_area'] = createExportWrapper('lv_inv_area');
var _lv_display_get_screen_active = Module['_lv_display_get_screen_active'] = createExportWrapper('lv_display_get_screen_active');
var _lv_display_get_screen_prev = Module['_lv_display_get_screen_prev'] = createExportWrapper('lv_display_get_screen_prev');
var _lv_display_get_layer_bottom = Module['_lv_display_get_layer_bottom'] = createExportWrapper('lv_display_get_layer_bottom');
var _lv_display_get_layer_top = Module['_lv_display_get_layer_top'] = createExportWrapper('lv_display_get_layer_top');
var _lv_display_get_layer_sys = Module['_lv_display_get_layer_sys'] = createExportWrapper('lv_display_get_layer_sys');
var _lv_area_intersect = Module['_lv_area_intersect'] = createExportWrapper('lv_area_intersect');
...
var _lv_area_is_point_on = Module['_lv_area_is_point_on'] = createExportWrapper('lv_area_is_point_on');
var _lv_obj_center = Module['_lv_obj_center'] = createExportWrapper('lv_obj_center');
...
var _lv_anim_set_var = Module['_lv_anim_set_var'] = createExportWrapper('lv_anim_set_var');
var _lv_anim_set_deleted_cb = Module['_lv_anim_set_deleted_cb'] = createExportWrapper('lv_anim_set_deleted_cb');
var _lv_anim_speed_clamped = Module['_lv_anim_speed_clamped'] = createExportWrapper('lv_anim_speed_clamped');
var _lv_anim_set_duration = Module['_lv_anim_set_duration'] = createExportWrapper('lv_anim_set_duration');
var _lv_anim_set_values = Module['_lv_anim_set_values'] = createExportWrapper('lv_anim_set_values');
var _lv_anim_set_exec_cb = Module['_lv_anim_set_exec_cb'] = createExportWrapper('lv_anim_set_exec_cb');
var _lv_anim_path_ease_out = Module['_lv_anim_path_ease_out'] = createExportWrapper('lv_anim_path_ease_out');
var _lv_anim_set_path_cb = Module['_lv_anim_set_path_cb'] = createExportWrapper('lv_anim_set_path_cb');
var _lv_anim_start = Module['_lv_anim_start'] = createExportWrapper('lv_anim_start');
var _lv_obj_scroll_by_raw = Module['_lv_obj_scroll_by_raw'] = createExportWrapper('lv_obj_scroll_by_raw');
...
var _lv_display_get_dpi = Module['_lv_display_get_dpi'] = createExportWrapper('lv_display_get_dpi');
var _lv_obj_style_init = Module['_lv_obj_style_init'] = createExportWrapper('lv_obj_style_init');
var _lv_obj_style_deinit = Module['_lv_obj_style_deinit'] = createExportWrapper('lv_obj_style_deinit');
var _lv_style_prop_lookup_flags = Module['_lv_style_prop_lookup_flags'] = createExportWrapper('lv_style_prop_lookup_flags');
var _lv_memset = Module['_lv_memset'] = createExportWrapper('lv_memset');
...
var _lv_obj_replace_style = Module['_lv_obj_replace_style'] = createExportWrapper('lv_obj_replace_style');
var _lv_obj_report_style_change = Module['_lv_obj_report_style_change'] = createExportWrapper('lv_obj_report_style_change');
var _lv_obj_has_style_prop = Module['_lv_obj_has_style_prop'] = createExportWrapper('lv_obj_has_style_prop');
...
var _lv_color_eq = Module['_lv_color_eq'] = createExportWrapper('lv_color_eq');
var _lv_anim_set_start_cb = Module['_lv_anim_set_start_cb'] = createExportWrapper('lv_anim_set_start_cb');
var _lv_anim_set_completed_cb = Module['_lv_anim_set_completed_cb'] = createExportWrapper('lv_anim_set_completed_cb');
var _lv_anim_set_delay = Module['_lv_anim_set_delay'] = createExportWrapper('lv_anim_set_delay');
var _lv_anim_set_early_apply = Module['_lv_anim_set_early_apply'] = createExportWrapper('lv_anim_set_early_apply');
var _lv_anim_set_user_data = Module['_lv_anim_set_user_data'] = createExportWrapper('lv_anim_set_user_data');
var _lv_color_mix = Module['_lv_color_mix'] = createExportWrapper('lv_color_mix');
...
var _lv_obj_set_style_length = Module['_lv_obj_set_style_length'] = createExportWrapper('lv_obj_set_style_length');
...
var _lv_obj_set_style_transform_scale_x = Module['_lv_obj_set_style_transform_scale_x'] = createExportWrapper('lv_obj_set_style_transform_scale_x');
var _lv_obj_set_style_transform_scale_y = Module['_lv_obj_set_style_transform_scale_y'] = createExportWrapper('lv_obj_set_style_transform_scale_y');
var _lv_obj_set_style_transform_rotation = Module['_lv_obj_set_style_transform_rotation'] = createExportWrapper('lv_obj_set_style_transform_rotation');
...
var _lv_obj_set_style_transform_skew_x = Module['_lv_obj_set_style_transform_skew_x'] = createExportWrapper('lv_obj_set_style_transform_skew_x');
var _lv_obj_set_style_transform_skew_y = Module['_lv_obj_set_style_transform_skew_y'] = createExportWrapper('lv_obj_set_style_transform_skew_y');
...
var _lv_obj_set_style_margin_top = Module['_lv_obj_set_style_margin_top'] = createExportWrapper('lv_obj_set_style_margin_top');
var _lv_obj_set_style_margin_bottom = Module['_lv_obj_set_style_margin_bottom'] = createExportWrapper('lv_obj_set_style_margin_bottom');
var _lv_obj_set_style_margin_left = Module['_lv_obj_set_style_margin_left'] = createExportWrapper('lv_obj_set_style_margin_left');
var _lv_obj_set_style_margin_right = Module['_lv_obj_set_style_margin_right'] = createExportWrapper('lv_obj_set_style_margin_right');
...
var _lv_obj_set_style_bg_main_opa = Module['_lv_obj_set_style_bg_main_opa'] = createExportWrapper('lv_obj_set_style_bg_main_opa');
var _lv_obj_set_style_bg_grad_opa = Module['_lv_obj_set_style_bg_grad_opa'] = createExportWrapper('lv_obj_set_style_bg_grad_opa');
var _lv_obj_set_style_bg_grad = Module['_lv_obj_set_style_bg_grad'] = createExportWrapper('lv_obj_set_style_bg_grad');
var _lv_obj_set_style_bg_image_src = Module['_lv_obj_set_style_bg_image_src'] = createExportWrapper('lv_obj_set_style_bg_image_src');
var _lv_obj_set_style_bg_image_opa = Module['_lv_obj_set_style_bg_image_opa'] = createExportWrapper('lv_obj_set_style_bg_image_opa');
var _lv_obj_set_style_bg_image_recolor = Module['_lv_obj_set_style_bg_image_recolor'] = createExportWrapper('lv_obj_set_style_bg_image_recolor');
var _lv_obj_set_style_bg_image_recolor_opa = Module['_lv_obj_set_style_bg_image_recolor_opa'] = createExportWrapper('lv_obj_set_style_bg_image_recolor_opa');
var _lv_obj_set_style_bg_image_tiled = Module['_lv_obj_set_style_bg_image_tiled'] = createExportWrapper('lv_obj_set_style_bg_image_tiled');
...
var _lv_obj_set_style_shadow_offset_x = Module['_lv_obj_set_style_shadow_offset_x'] = createExportWrapper('lv_obj_set_style_shadow_offset_x');
var _lv_obj_set_style_shadow_offset_y = Module['_lv_obj_set_style_shadow_offset_y'] = createExportWrapper('lv_obj_set_style_shadow_offset_y');
...
var _lv_obj_set_style_image_opa = Module['_lv_obj_set_style_image_opa'] = createExportWrapper('lv_obj_set_style_image_opa');
var _lv_obj_set_style_image_recolor = Module['_lv_obj_set_style_image_recolor'] = createExportWrapper('lv_obj_set_style_image_recolor');
var _lv_obj_set_style_image_recolor_opa = Module['_lv_obj_set_style_image_recolor_opa'] = createExportWrapper('lv_obj_set_style_image_recolor_opa');
...
var _lv_obj_set_style_arc_image_src = Module['_lv_obj_set_style_arc_image_src'] = createExportWrapper('lv_obj_set_style_arc_image_src');
...
var _lv_obj_set_style_anim_duration = Module['_lv_obj_set_style_anim_duration'] = createExportWrapper('lv_obj_set_style_anim_duration');
...
var _lv_obj_set_style_bitmap_mask_src = Module['_lv_obj_set_style_bitmap_mask_src'] = createExportWrapper('lv_obj_set_style_bitmap_mask_src');
var _lv_obj_set_style_rotary_sensitivity = Module['_lv_obj_set_style_rotary_sensitivity'] = createExportWrapper('lv_obj_set_style_rotary_sensitivity');
...
var _lv_indev_get_state = Module['_lv_indev_get_state'] = createExportWrapper('lv_indev_get_state');
var _lv_indev_wait_release = Module['_lv_indev_wait_release'] = createExportWrapper('lv_indev_wait_release');
var _lv_indev_get_active_obj = Module['_lv_indev_get_active_obj'] = createExportWrapper('lv_indev_get_active_obj');
...
var _lv_obj_delete_delayed = Module['_lv_obj_delete_delayed'] = createExportWrapper('lv_obj_delete_delayed');
var _lv_obj_delete_anim_completed_cb = Module['_lv_obj_delete_anim_completed_cb'] = createExportWrapper('lv_obj_delete_anim_completed_cb');
var _lv_obj_delete_async = Module['_lv_obj_delete_async'] = createExportWrapper('lv_obj_delete_async');
...
var _lv_obj_get_sibling = Module['_lv_obj_get_sibling'] = createExportWrapper('lv_obj_get_sibling');
var _lv_obj_get_sibling_by_type = Module['_lv_obj_get_sibling_by_type'] = createExportWrapper('lv_obj_get_sibling_by_type');
var _lv_obj_get_index_by_type = Module['_lv_obj_get_index_by_type'] = createExportWrapper('lv_obj_get_index_by_type');
var _lv_obj_get_child_count_by_type = Module['_lv_obj_get_child_count_by_type'] = createExportWrapper('lv_obj_get_child_count_by_type');
var _lv_obj_tree_walk = Module['_lv_obj_tree_walk'] = createExportWrapper('lv_obj_tree_walk');
var _lv_obj_dump_tree = Module['_lv_obj_dump_tree'] = createExportWrapper('lv_obj_dump_tree');
var _lv_refr_init = Module['_lv_refr_init'] = createExportWrapper('lv_refr_init');
var _lv_refr_deinit = Module['_lv_refr_deinit'] = createExportWrapper('lv_refr_deinit');
var _lv_refr_now = Module['_lv_refr_now'] = createExportWrapper('lv_refr_now');
var _lv_display_refr_timer = Module['_lv_display_refr_timer'] = createExportWrapper('lv_display_refr_timer');
...
var _lv_area_is_on = Module['_lv_area_is_on'] = createExportWrapper('lv_area_is_on');
var _lv_area_join = Module['_lv_area_join'] = createExportWrapper('lv_area_join');
var _lv_display_is_double_buffered = Module['_lv_display_is_double_buffered'] = createExportWrapper('lv_display_is_double_buffered');
var _lv_ll_is_empty = Module['_lv_ll_is_empty'] = createExportWrapper('lv_ll_is_empty');
var _lv_area_diff = Module['_lv_area_diff'] = createExportWrapper('lv_area_diff');
var _lv_ll_ins_prev = Module['_lv_ll_ins_prev'] = createExportWrapper('lv_ll_ins_prev');
var _lv_draw_buf_copy = Module['_lv_draw_buf_copy'] = createExportWrapper('lv_draw_buf_copy');
var _lv_draw_buf_reshape = Module['_lv_draw_buf_reshape'] = createExportWrapper('lv_draw_buf_reshape');
var _lv_draw_buf_width_to_stride = Module['_lv_draw_buf_width_to_stride'] = createExportWrapper('lv_draw_buf_width_to_stride');
var _lv_draw_sw_mask_cleanup = Module['_lv_draw_sw_mask_cleanup'] = createExportWrapper('lv_draw_sw_mask_cleanup');
var _lv_draw_mask_rect_dsc_init = Module['_lv_draw_mask_rect_dsc_init'] = createExportWrapper('lv_draw_mask_rect_dsc_init');
var _lv_draw_image_dsc_init = Module['_lv_draw_image_dsc_init'] = createExportWrapper('lv_draw_image_dsc_init');
var _lv_draw_layer_create = Module['_lv_draw_layer_create'] = createExportWrapper('lv_draw_layer_create');
var _lv_draw_mask_rect = Module['_lv_draw_mask_rect'] = createExportWrapper('lv_draw_mask_rect');
var _lv_draw_layer = Module['_lv_draw_layer'] = createExportWrapper('lv_draw_layer');
var _lv_color_format_get_size = Module['_lv_color_format_get_size'] = createExportWrapper('lv_color_format_get_size');
var _lv_refr_get_disp_refreshing = Module['_lv_refr_get_disp_refreshing'] = createExportWrapper('lv_refr_get_disp_refreshing');
var _lv_refr_set_disp_refreshing = Module['_lv_refr_set_disp_refreshing'] = createExportWrapper('lv_refr_set_disp_refreshing');
var _lv_color_format_has_alpha = Module['_lv_color_format_has_alpha'] = createExportWrapper('lv_color_format_has_alpha');
var _lv_area_move = Module['_lv_area_move'] = createExportWrapper('lv_area_move');
var _lv_draw_buf_clear = Module['_lv_draw_buf_clear'] = createExportWrapper('lv_draw_buf_clear');
var _lv_draw_dispatch_wait_for_request = Module['_lv_draw_dispatch_wait_for_request'] = createExportWrapper('lv_draw_dispatch_wait_for_request');
var _lv_draw_dispatch = Module['_lv_draw_dispatch'] = createExportWrapper('lv_draw_dispatch');
...
var _lv_display_add_event_cb = Module['_lv_display_add_event_cb'] = createExportWrapper('lv_display_add_event_cb');
var _lv_timer_resume = Module['_lv_timer_resume'] = createExportWrapper('lv_timer_resume');
var _lv_display_delete = Module['_lv_display_delete'] = createExportWrapper('lv_display_delete');
var _lv_indev_get_display = Module['_lv_indev_get_display'] = createExportWrapper('lv_indev_get_display');
var _lv_indev_set_display = Module['_lv_indev_set_display'] = createExportWrapper('lv_indev_set_display');
var _lv_timer_delete = Module['_lv_timer_delete'] = createExportWrapper('lv_timer_delete');
var _lv_display_set_default = Module['_lv_display_set_default'] = createExportWrapper('lv_display_set_default');
var _lv_display_set_resolution = Module['_lv_display_set_resolution'] = createExportWrapper('lv_display_set_resolution');
...
var _lv_display_set_physical_resolution = Module['_lv_display_set_physical_resolution'] = createExportWrapper('lv_display_set_physical_resolution');
var _lv_display_set_offset = Module['_lv_display_set_offset'] = createExportWrapper('lv_display_set_offset');
var _lv_display_set_dpi = Module['_lv_display_set_dpi'] = createExportWrapper('lv_display_set_dpi');
var _lv_display_get_physical_horizontal_resolution = Module['_lv_display_get_physical_horizontal_resolution'] = createExportWrapper('lv_display_get_physical_horizontal_resolution');
var _lv_display_get_physical_vertical_resolution = Module['_lv_display_get_physical_vertical_resolution'] = createExportWrapper('lv_display_get_physical_vertical_resolution');
var _lv_display_get_offset_x = Module['_lv_display_get_offset_x'] = createExportWrapper('lv_display_get_offset_x');
var _lv_display_get_offset_y = Module['_lv_display_get_offset_y'] = createExportWrapper('lv_display_get_offset_y');
var _lv_display_set_draw_buffers = Module['_lv_display_set_draw_buffers'] = createExportWrapper('lv_display_set_draw_buffers');
var _lv_draw_buf_align = Module['_lv_draw_buf_align'] = createExportWrapper('lv_draw_buf_align');
var _lv_draw_buf_init = Module['_lv_draw_buf_init'] = createExportWrapper('lv_draw_buf_init');
var _lv_display_get_color_format = Module['_lv_display_get_color_format'] = createExportWrapper('lv_display_get_color_format');
var _lv_display_set_render_mode = Module['_lv_display_set_render_mode'] = createExportWrapper('lv_display_set_render_mode');
var _lv_display_set_flush_wait_cb = Module['_lv_display_set_flush_wait_cb'] = createExportWrapper('lv_display_set_flush_wait_cb');
var _lv_display_set_color_format = Module['_lv_display_set_color_format'] = createExportWrapper('lv_display_set_color_format');
var _lv_display_set_antialiasing = Module['_lv_display_set_antialiasing'] = createExportWrapper('lv_display_set_antialiasing');
var _lv_display_get_antialiasing = Module['_lv_display_get_antialiasing'] = createExportWrapper('lv_display_get_antialiasing');
var _lv_display_flush_is_last = Module['_lv_display_flush_is_last'] = createExportWrapper('lv_display_flush_is_last');
var _lv_display_get_event_count = Module['_lv_display_get_event_count'] = createExportWrapper('lv_display_get_event_count');
var _lv_display_get_event_dsc = Module['_lv_display_get_event_dsc'] = createExportWrapper('lv_display_get_event_dsc');
var _lv_display_delete_event = Module['_lv_display_delete_event'] = createExportWrapper('lv_display_delete_event');
var _lv_display_remove_event_cb_with_user_data = Module['_lv_display_remove_event_cb_with_user_data'] = createExportWrapper('lv_display_remove_event_cb_with_user_data');
var _lv_display_set_rotation = Module['_lv_display_set_rotation'] = createExportWrapper('lv_display_set_rotation');
var _lv_display_get_rotation = Module['_lv_display_get_rotation'] = createExportWrapper('lv_display_get_rotation');
var _lv_display_get_theme = Module['_lv_display_get_theme'] = createExportWrapper('lv_display_get_theme');
var _lv_display_get_inactive_time = Module['_lv_display_get_inactive_time'] = createExportWrapper('lv_display_get_inactive_time');
var _lv_tick_elaps = Module['_lv_tick_elaps'] = createExportWrapper('lv_tick_elaps');
var _lv_display_trigger_activity = Module['_lv_display_trigger_activity'] = createExportWrapper('lv_display_trigger_activity');
var _lv_display_enable_invalidation = Module['_lv_display_enable_invalidation'] = createExportWrapper('lv_display_enable_invalidation');
var _lv_display_get_refr_timer = Module['_lv_display_get_refr_timer'] = createExportWrapper('lv_display_get_refr_timer');
var _lv_display_delete_refr_timer = Module['_lv_display_delete_refr_timer'] = createExportWrapper('lv_display_delete_refr_timer');
var _lv_display_set_user_data = Module['_lv_display_set_user_data'] = createExportWrapper('lv_display_set_user_data');
var _lv_display_set_driver_data = Module['_lv_display_set_driver_data'] = createExportWrapper('lv_display_set_driver_data');
var _lv_display_get_user_data = Module['_lv_display_get_user_data'] = createExportWrapper('lv_display_get_user_data');
var _lv_display_get_driver_data = Module['_lv_display_get_driver_data'] = createExportWrapper('lv_display_get_driver_data');
var _lv_display_get_buf_active = Module['_lv_display_get_buf_active'] = createExportWrapper('lv_display_get_buf_active');
var _lv_display_rotate_area = Module['_lv_display_rotate_area'] = createExportWrapper('lv_display_rotate_area');
var _lv_layer_top = Module['_lv_layer_top'] = createExportWrapper('lv_layer_top');
var _lv_layer_sys = Module['_lv_layer_sys'] = createExportWrapper('lv_layer_sys');
var _lv_layer_bottom = Module['_lv_layer_bottom'] = createExportWrapper('lv_layer_bottom');
var _lv_dpx = Module['_lv_dpx'] = createExportWrapper('lv_dpx');
var _lv_display_dpx = Module['_lv_display_dpx'] = createExportWrapper('lv_display_dpx');
var _lv_draw_init = Module['_lv_draw_init'] = createExportWrapper('lv_draw_init');
var _lv_draw_deinit = Module['_lv_draw_deinit'] = createExportWrapper('lv_draw_deinit');
var _lv_draw_create_unit = Module['_lv_draw_create_unit'] = createExportWrapper('lv_draw_create_unit');
var _lv_draw_add_task = Module['_lv_draw_add_task'] = createExportWrapper('lv_draw_add_task');
var _lv_draw_finalize_task_creation = Module['_lv_draw_finalize_task_creation'] = createExportWrapper('lv_draw_finalize_task_creation');
var _lv_draw_dispatch_layer = Module['_lv_draw_dispatch_layer'] = createExportWrapper('lv_draw_dispatch_layer');
var _lv_draw_wait_for_finish = Module['_lv_draw_wait_for_finish'] = createExportWrapper('lv_draw_wait_for_finish');
var _lv_draw_buf_destroy = Module['_lv_draw_buf_destroy'] = createExportWrapper('lv_draw_buf_destroy');
var _lv_draw_task_get_label_dsc = Module['_lv_draw_task_get_label_dsc'] = createExportWrapper('lv_draw_task_get_label_dsc');
var _lv_draw_dispatch_request = Module['_lv_draw_dispatch_request'] = createExportWrapper('lv_draw_dispatch_request');
var _lv_draw_get_unit_count = Module['_lv_draw_get_unit_count'] = createExportWrapper('lv_draw_get_unit_count');
var _lv_draw_get_next_available_task = Module['_lv_draw_get_next_available_task'] = createExportWrapper('lv_draw_get_next_available_task');
var _lv_draw_get_dependent_count = Module['_lv_draw_get_dependent_count'] = createExportWrapper('lv_draw_get_dependent_count');
var _lv_draw_layer_alloc_buf = Module['_lv_draw_layer_alloc_buf'] = createExportWrapper('lv_draw_layer_alloc_buf');
var _lv_draw_buf_create = Module['_lv_draw_buf_create'] = createExportWrapper('lv_draw_buf_create');
var _lv_draw_layer_go_to_xy = Module['_lv_draw_layer_go_to_xy'] = createExportWrapper('lv_draw_layer_go_to_xy');
var _lv_draw_buf_goto_xy = Module['_lv_draw_buf_goto_xy'] = createExportWrapper('lv_draw_buf_goto_xy');
var _lv_draw_task_get_type = Module['_lv_draw_task_get_type'] = createExportWrapper('lv_draw_task_get_type');
var _lv_draw_task_get_draw_dsc = Module['_lv_draw_task_get_draw_dsc'] = createExportWrapper('lv_draw_task_get_draw_dsc');
var _lv_draw_task_get_area = Module['_lv_draw_task_get_area'] = createExportWrapper('lv_draw_task_get_area');
var _lv_draw_arc_dsc_init = Module['_lv_draw_arc_dsc_init'] = createExportWrapper('lv_draw_arc_dsc_init');
var _lv_draw_task_get_arc_dsc = Module['_lv_draw_task_get_arc_dsc'] = createExportWrapper('lv_draw_task_get_arc_dsc');
...
var _lv_draw_buf_init_handlers = Module['_lv_draw_buf_init_handlers'] = createExportWrapper('lv_draw_buf_init_handlers');
var _lv_draw_buf_init_with_default_handlers = Module['_lv_draw_buf_init_with_default_handlers'] = createExportWrapper('lv_draw_buf_init_with_default_handlers');
var _lv_draw_buf_handlers_init = Module['_lv_draw_buf_handlers_init'] = createExportWrapper('lv_draw_buf_handlers_init');
var _lv_draw_buf_get_handlers = Module['_lv_draw_buf_get_handlers'] = createExportWrapper('lv_draw_buf_get_handlers');
var _lv_draw_buf_get_font_handlers = Module['_lv_draw_buf_get_font_handlers'] = createExportWrapper('lv_draw_buf_get_font_handlers');
var _lv_draw_buf_get_image_handlers = Module['_lv_draw_buf_get_image_handlers'] = createExportWrapper('lv_draw_buf_get_image_handlers');
var _lv_color_format_get_bpp = Module['_lv_color_format_get_bpp'] = createExportWrapper('lv_color_format_get_bpp');
var _lv_draw_buf_width_to_stride_ex = Module['_lv_draw_buf_width_to_stride_ex'] = createExportWrapper('lv_draw_buf_width_to_stride_ex');
var _lv_draw_buf_align_ex = Module['_lv_draw_buf_align_ex'] = createExportWrapper('lv_draw_buf_align_ex');
var _lv_draw_buf_invalidate_cache = Module['_lv_draw_buf_invalidate_cache'] = createExportWrapper('lv_draw_buf_invalidate_cache');
var _lv_draw_buf_flush_cache = Module['_lv_draw_buf_flush_cache'] = createExportWrapper('lv_draw_buf_flush_cache');
var _lv_draw_buf_create_ex = Module['_lv_draw_buf_create_ex'] = createExportWrapper('lv_draw_buf_create_ex');
var _lv_draw_buf_dup = Module['_lv_draw_buf_dup'] = createExportWrapper('lv_draw_buf_dup');
var _lv_draw_buf_dup_ex = Module['_lv_draw_buf_dup_ex'] = createExportWrapper('lv_draw_buf_dup_ex');
var _lv_draw_buf_adjust_stride = Module['_lv_draw_buf_adjust_stride'] = createExportWrapper('lv_draw_buf_adjust_stride');
var _lv_memmove = Module['_lv_memmove'] = createExportWrapper('lv_memmove');
var _lv_draw_buf_has_flag = Module['_lv_draw_buf_has_flag'] = createExportWrapper('lv_draw_buf_has_flag');
var _lv_draw_buf_premultiply = Module['_lv_draw_buf_premultiply'] = createExportWrapper('lv_draw_buf_premultiply');
var _lv_color_premultiply = Module['_lv_color_premultiply'] = createExportWrapper('lv_color_premultiply');
var _lv_color16_premultiply = Module['_lv_color16_premultiply'] = createExportWrapper('lv_color16_premultiply');
var _lv_draw_buf_set_palette = Module['_lv_draw_buf_set_palette'] = createExportWrapper('lv_draw_buf_set_palette');
var _lv_draw_buf_set_flag = Module['_lv_draw_buf_set_flag'] = createExportWrapper('lv_draw_buf_set_flag');
var _lv_draw_buf_clear_flag = Module['_lv_draw_buf_clear_flag'] = createExportWrapper('lv_draw_buf_clear_flag');
var _lv_draw_buf_from_image = Module['_lv_draw_buf_from_image'] = createExportWrapper('lv_draw_buf_from_image');
var _lv_draw_buf_to_image = Module['_lv_draw_buf_to_image'] = createExportWrapper('lv_draw_buf_to_image');
var _lv_image_buf_set_palette = Module['_lv_image_buf_set_palette'] = createExportWrapper('lv_image_buf_set_palette');
var _lv_image_buf_free = Module['_lv_image_buf_free'] = createExportWrapper('lv_image_buf_free');
var _lv_color_black = Module['_lv_color_black'] = createExportWrapper('lv_color_black');
var _lv_draw_task_get_image_dsc = Module['_lv_draw_task_get_image_dsc'] = createExportWrapper('lv_draw_task_get_image_dsc');
var _lv_image_buf_get_transformed_area = Module['_lv_image_buf_get_transformed_area'] = createExportWrapper('lv_image_buf_get_transformed_area');
var _lv_point_transform = Module['_lv_point_transform'] = createExportWrapper('lv_point_transform');
var _lv_draw_image = Module['_lv_draw_image'] = createExportWrapper('lv_draw_image');
var _lv_image_decoder_get_info = Module['_lv_image_decoder_get_info'] = createExportWrapper('lv_image_decoder_get_info');
var _lv_draw_image_normal_helper = Module['_lv_draw_image_normal_helper'] = createExportWrapper('lv_draw_image_normal_helper');
var _lv_image_decoder_open = Module['_lv_image_decoder_open'] = createExportWrapper('lv_image_decoder_open');
var _lv_image_decoder_close = Module['_lv_image_decoder_close'] = createExportWrapper('lv_image_decoder_close');
var _lv_image_decoder_get_area = Module['_lv_image_decoder_get_area'] = createExportWrapper('lv_image_decoder_get_area');
var _lv_draw_image_tiled_helper = Module['_lv_draw_image_tiled_helper'] = createExportWrapper('lv_draw_image_tiled_helper');
var _lv_draw_label_dsc_init = Module['_lv_draw_label_dsc_init'] = createExportWrapper('lv_draw_label_dsc_init');
var _lv_draw_glyph_dsc_init = Module['_lv_draw_glyph_dsc_init'] = createExportWrapper('lv_draw_glyph_dsc_init');
var _lv_draw_label = Module['_lv_draw_label'] = createExportWrapper('lv_draw_label');
var _lv_strdup = Module['_lv_strdup'] = createExportWrapper('lv_strdup');
var _lv_draw_character = Module['_lv_draw_character'] = createExportWrapper('lv_draw_character');
var _lv_font_get_glyph_dsc = Module['_lv_font_get_glyph_dsc'] = createExportWrapper('lv_font_get_glyph_dsc');
var _lv_font_get_line_height = Module['_lv_font_get_line_height'] = createExportWrapper('lv_font_get_line_height');
var _lv_draw_label_iterate_characters = Module['_lv_draw_label_iterate_characters'] = createExportWrapper('lv_draw_label_iterate_characters');
var _lv_text_get_size = Module['_lv_text_get_size'] = createExportWrapper('lv_text_get_size');
var _lv_point_set = Module['_lv_point_set'] = createExportWrapper('lv_point_set');
var _lv_text_get_next_line = Module['_lv_text_get_next_line'] = createExportWrapper('lv_text_get_next_line');
var _lv_text_get_width = Module['_lv_text_get_width'] = createExportWrapper('lv_text_get_width');
var _lv_draw_fill_dsc_init = Module['_lv_draw_fill_dsc_init'] = createExportWrapper('lv_draw_fill_dsc_init');
var _lv_bidi_process_paragraph = Module['_lv_bidi_process_paragraph'] = createExportWrapper('lv_bidi_process_paragraph');
var _lv_bidi_get_logical_pos = Module['_lv_bidi_get_logical_pos'] = createExportWrapper('lv_bidi_get_logical_pos');
var _lv_text_encoded_letter_next_2 = Module['_lv_text_encoded_letter_next_2'] = createExportWrapper('lv_text_encoded_letter_next_2');
var _lv_font_get_glyph_width = Module['_lv_font_get_glyph_width'] = createExportWrapper('lv_font_get_glyph_width');
var _lv_area_is_out = Module['_lv_area_is_out'] = createExportWrapper('lv_area_is_out');
var _lv_font_get_glyph_bitmap = Module['_lv_font_get_glyph_bitmap'] = createExportWrapper('lv_font_get_glyph_bitmap');
var _lv_font_glyph_release_draw_data = Module['_lv_font_glyph_release_draw_data'] = createExportWrapper('lv_font_glyph_release_draw_data');
var _lv_draw_line_dsc_init = Module['_lv_draw_line_dsc_init'] = createExportWrapper('lv_draw_line_dsc_init');
var _lv_draw_task_get_line_dsc = Module['_lv_draw_task_get_line_dsc'] = createExportWrapper('lv_draw_task_get_line_dsc');
var _lv_draw_line = Module['_lv_draw_line'] = createExportWrapper('lv_draw_line');
var _lv_draw_task_get_mask_rect_dsc = Module['_lv_draw_task_get_mask_rect_dsc'] = createExportWrapper('lv_draw_task_get_mask_rect_dsc');
var _lv_color_white = Module['_lv_color_white'] = createExportWrapper('lv_color_white');
var _lv_draw_task_get_fill_dsc = Module['_lv_draw_task_get_fill_dsc'] = createExportWrapper('lv_draw_task_get_fill_dsc');
var _lv_draw_border_dsc_init = Module['_lv_draw_border_dsc_init'] = createExportWrapper('lv_draw_border_dsc_init');
var _lv_draw_task_get_border_dsc = Module['_lv_draw_task_get_border_dsc'] = createExportWrapper('lv_draw_task_get_border_dsc');
var _lv_draw_box_shadow_dsc_init = Module['_lv_draw_box_shadow_dsc_init'] = createExportWrapper('lv_draw_box_shadow_dsc_init');
var _lv_draw_task_get_box_shadow_dsc = Module['_lv_draw_task_get_box_shadow_dsc'] = createExportWrapper('lv_draw_task_get_box_shadow_dsc');
var _lv_area_align = Module['_lv_area_align'] = createExportWrapper('lv_area_align');
var _lv_draw_triangle_dsc_init = Module['_lv_draw_triangle_dsc_init'] = createExportWrapper('lv_draw_triangle_dsc_init');
var _lv_draw_task_get_triangle_dsc = Module['_lv_draw_task_get_triangle_dsc'] = createExportWrapper('lv_draw_task_get_triangle_dsc');
var _lv_draw_triangle = Module['_lv_draw_triangle'] = createExportWrapper('lv_draw_triangle');
var _lv_image_decoder_init = Module['_lv_image_decoder_init'] = createExportWrapper('lv_image_decoder_init');
var _lv_image_decoder_deinit = Module['_lv_image_decoder_deinit'] = createExportWrapper('lv_image_decoder_deinit');
var _lv_image_cache_init = Module['_lv_image_cache_init'] = createExportWrapper('lv_image_cache_init');
var _lv_image_header_cache_init = Module['_lv_image_header_cache_init'] = createExportWrapper('lv_image_header_cache_init');
var _lv_cache_destroy = Module['_lv_cache_destroy'] = createExportWrapper('lv_cache_destroy');
var _lv_image_header_cache_is_enabled = Module['_lv_image_header_cache_is_enabled'] = createExportWrapper('lv_image_header_cache_is_enabled');
var _lv_cache_acquire = Module['_lv_cache_acquire'] = createExportWrapper('lv_cache_acquire');
var _lv_cache_entry_get_data = Module['_lv_cache_entry_get_data'] = createExportWrapper('lv_cache_entry_get_data');
var _lv_cache_release = Module['_lv_cache_release'] = createExportWrapper('lv_cache_release');
...
var _lv_cache_add = Module['_lv_cache_add'] = createExportWrapper('lv_cache_add');
var _lv_image_cache_is_enabled = Module['_lv_image_cache_is_enabled'] = createExportWrapper('lv_image_cache_is_enabled');
var _lv_image_decoder_create = Module['_lv_image_decoder_create'] = createExportWrapper('lv_image_decoder_create');
var _lv_image_decoder_delete = Module['_lv_image_decoder_delete'] = createExportWrapper('lv_image_decoder_delete');
var _lv_image_decoder_get_next = Module['_lv_image_decoder_get_next'] = createExportWrapper('lv_image_decoder_get_next');
var _lv_image_decoder_set_info_cb = Module['_lv_image_decoder_set_info_cb'] = createExportWrapper('lv_image_decoder_set_info_cb');
var _lv_image_decoder_set_open_cb = Module['_lv_image_decoder_set_open_cb'] = createExportWrapper('lv_image_decoder_set_open_cb');
var _lv_image_decoder_set_get_area_cb = Module['_lv_image_decoder_set_get_area_cb'] = createExportWrapper('lv_image_decoder_set_get_area_cb');
var _lv_image_decoder_set_close_cb = Module['_lv_image_decoder_set_close_cb'] = createExportWrapper('lv_image_decoder_set_close_cb');
var _lv_image_decoder_add_to_cache = Module['_lv_image_decoder_add_to_cache'] = createExportWrapper('lv_image_decoder_add_to_cache');
var _lv_image_decoder_post_process = Module['_lv_image_decoder_post_process'] = createExportWrapper('lv_image_decoder_post_process');
var _lv_draw_sw_blend = Module['_lv_draw_sw_blend'] = createExportWrapper('lv_draw_sw_blend');
var _lv_draw_sw_blend_color_to_al88 = Module['_lv_draw_sw_blend_color_to_al88'] = createExportWrapper('lv_draw_sw_blend_color_to_al88');
var _lv_draw_sw_blend_image_to_al88 = Module['_lv_draw_sw_blend_image_to_al88'] = createExportWrapper('lv_draw_sw_blend_image_to_al88');
var _lv_draw_sw_blend_color_to_argb8888 = Module['_lv_draw_sw_blend_color_to_argb8888'] = createExportWrapper('lv_draw_sw_blend_color_to_argb8888');
var _lv_draw_sw_blend_image_to_argb8888 = Module['_lv_draw_sw_blend_image_to_argb8888'] = createExportWrapper('lv_draw_sw_blend_image_to_argb8888');
var _lv_draw_sw_blend_color_to_i1 = Module['_lv_draw_sw_blend_color_to_i1'] = createExportWrapper('lv_draw_sw_blend_color_to_i1');
var _lv_draw_sw_blend_image_to_i1 = Module['_lv_draw_sw_blend_image_to_i1'] = createExportWrapper('lv_draw_sw_blend_image_to_i1');
var _lv_draw_sw_blend_color_to_l8 = Module['_lv_draw_sw_blend_color_to_l8'] = createExportWrapper('lv_draw_sw_blend_color_to_l8');
var _lv_draw_sw_blend_image_to_l8 = Module['_lv_draw_sw_blend_image_to_l8'] = createExportWrapper('lv_draw_sw_blend_image_to_l8');
var _lv_draw_sw_blend_color_to_rgb565 = Module['_lv_draw_sw_blend_color_to_rgb565'] = createExportWrapper('lv_draw_sw_blend_color_to_rgb565');
var _lv_draw_sw_blend_image_to_rgb565 = Module['_lv_draw_sw_blend_image_to_rgb565'] = createExportWrapper('lv_draw_sw_blend_image_to_rgb565');
var _lv_draw_sw_blend_color_to_rgb888 = Module['_lv_draw_sw_blend_color_to_rgb888'] = createExportWrapper('lv_draw_sw_blend_color_to_rgb888');
var _lv_draw_sw_blend_image_to_rgb888 = Module['_lv_draw_sw_blend_image_to_rgb888'] = createExportWrapper('lv_draw_sw_blend_image_to_rgb888');
var _lv_draw_sw_init = Module['_lv_draw_sw_init'] = createExportWrapper('lv_draw_sw_init');
var _lv_draw_sw_deinit = Module['_lv_draw_sw_deinit'] = createExportWrapper('lv_draw_sw_deinit');
var _lv_draw_sw_rgb565_swap = Module['_lv_draw_sw_rgb565_swap'] = createExportWrapper('lv_draw_sw_rgb565_swap');
var _lv_draw_sw_i1_invert = Module['_lv_draw_sw_i1_invert'] = createExportWrapper('lv_draw_sw_i1_invert');
var _lv_draw_sw_rotate = Module['_lv_draw_sw_rotate'] = createExportWrapper('lv_draw_sw_rotate');
var _lv_draw_sw_arc = Module['_lv_draw_sw_arc'] = createExportWrapper('lv_draw_sw_arc');
var _lv_draw_sw_border = Module['_lv_draw_sw_border'] = createExportWrapper('lv_draw_sw_border');
var _lv_draw_sw_box_shadow = Module['_lv_draw_sw_box_shadow'] = createExportWrapper('lv_draw_sw_box_shadow');
var _lv_draw_sw_fill = Module['_lv_draw_sw_fill'] = createExportWrapper('lv_draw_sw_fill');
var _lv_gradient_get = Module['_lv_gradient_get'] = createExportWrapper('lv_gradient_get');
var _lv_gradient_color_calculate = Module['_lv_gradient_color_calculate'] = createExportWrapper('lv_gradient_color_calculate');
var _lv_gradient_cleanup = Module['_lv_gradient_cleanup'] = createExportWrapper('lv_gradient_cleanup');
var _lv_gradient_init_stops = Module['_lv_gradient_init_stops'] = createExportWrapper('lv_gradient_init_stops');
var _lv_draw_sw_layer = Module['_lv_draw_sw_layer'] = createExportWrapper('lv_draw_sw_layer');
var _lv_draw_sw_image = Module['_lv_draw_sw_image'] = createExportWrapper('lv_draw_sw_image');
var _lv_draw_sw_label = Module['_lv_draw_sw_label'] = createExportWrapper('lv_draw_sw_label');
var _lv_draw_sw_line = Module['_lv_draw_sw_line'] = createExportWrapper('lv_draw_sw_line');
var _lv_draw_sw_mask_init = Module['_lv_draw_sw_mask_init'] = createExportWrapper('lv_draw_sw_mask_init');
var _lv_draw_sw_mask_deinit = Module['_lv_draw_sw_mask_deinit'] = createExportWrapper('lv_draw_sw_mask_deinit');
var _lv_draw_sw_mask_apply = Module['_lv_draw_sw_mask_apply'] = createExportWrapper('lv_draw_sw_mask_apply');
var _lv_draw_sw_mask_free_param = Module['_lv_draw_sw_mask_free_param'] = createExportWrapper('lv_draw_sw_mask_free_param');
var _lv_mutex_init = Module['_lv_mutex_init'] = createExportWrapper('lv_mutex_init');
var _lv_mutex_delete = Module['_lv_mutex_delete'] = createExportWrapper('lv_mutex_delete');
var _lv_mutex_lock = Module['_lv_mutex_lock'] = createExportWrapper('lv_mutex_lock');
var _lv_mutex_unlock = Module['_lv_mutex_unlock'] = createExportWrapper('lv_mutex_unlock');
var _lv_draw_sw_mask_line_points_init = Module['_lv_draw_sw_mask_line_points_init'] = createExportWrapper('lv_draw_sw_mask_line_points_init');
var _lv_draw_sw_mask_line_angle_init = Module['_lv_draw_sw_mask_line_angle_init'] = createExportWrapper('lv_draw_sw_mask_line_angle_init');
var _lv_trigo_sin = Module['_lv_trigo_sin'] = createExportWrapper('lv_trigo_sin');
var _lv_draw_sw_mask_angle_init = Module['_lv_draw_sw_mask_angle_init'] = createExportWrapper('lv_draw_sw_mask_angle_init');
var _lv_draw_sw_mask_radius_init = Module['_lv_draw_sw_mask_radius_init'] = createExportWrapper('lv_draw_sw_mask_radius_init');
var _lv_draw_sw_mask_fade_init = Module['_lv_draw_sw_mask_fade_init'] = createExportWrapper('lv_draw_sw_mask_fade_init');
var _lv_draw_sw_mask_map_init = Module['_lv_draw_sw_mask_map_init'] = createExportWrapper('lv_draw_sw_mask_map_init');
var _lv_draw_sw_mask_rect = Module['_lv_draw_sw_mask_rect'] = createExportWrapper('lv_draw_sw_mask_rect');
var _lv_draw_sw_transform = Module['_lv_draw_sw_transform'] = createExportWrapper('lv_draw_sw_transform');
var _lv_draw_sw_triangle = Module['_lv_draw_sw_triangle'] = createExportWrapper('lv_draw_sw_triangle');
...
var _lv_memcmp = Module['_lv_memcmp'] = createExportWrapper('lv_memcmp');
var _lv_font_set_kerning = Module['_lv_font_set_kerning'] = createExportWrapper('lv_font_set_kerning');
var _lv_font_default = Module['_lv_font_default'] = createExportWrapper('lv_font_default');
var _lv_utils_bsearch = Module['_lv_utils_bsearch'] = createExportWrapper('lv_utils_bsearch');
var _lv_indev_read_timer_cb = Module['_lv_indev_read_timer_cb'] = createExportWrapper('lv_indev_read_timer_cb');
var _lv_indev_read = Module['_lv_indev_read'] = createExportWrapper('lv_indev_read');
var _lv_indev_delete = Module['_lv_indev_delete'] = createExportWrapper('lv_indev_delete');
var _lv_indev_send_event = Module['_lv_indev_send_event'] = createExportWrapper('lv_indev_send_event');
var _lv_indev_find_scroll_obj = Module['_lv_indev_find_scroll_obj'] = createExportWrapper('lv_indev_find_scroll_obj');
var _lv_indev_scroll_handler = Module['_lv_indev_scroll_handler'] = createExportWrapper('lv_indev_scroll_handler');
var _lv_indev_enable = Module['_lv_indev_enable'] = createExportWrapper('lv_indev_enable');
var _lv_indev_set_user_data = Module['_lv_indev_set_user_data'] = createExportWrapper('lv_indev_set_user_data');
var _lv_indev_set_driver_data = Module['_lv_indev_set_driver_data'] = createExportWrapper('lv_indev_set_driver_data');
var _lv_indev_get_read_cb = Module['_lv_indev_get_read_cb'] = createExportWrapper('lv_indev_get_read_cb');
var _lv_indev_set_long_press_time = Module['_lv_indev_set_long_press_time'] = createExportWrapper('lv_indev_set_long_press_time');
var _lv_indev_set_scroll_limit = Module['_lv_indev_set_scroll_limit'] = createExportWrapper('lv_indev_set_scroll_limit');
var _lv_indev_set_scroll_throw = Module['_lv_indev_set_scroll_throw'] = createExportWrapper('lv_indev_set_scroll_throw');
var _lv_indev_get_user_data = Module['_lv_indev_get_user_data'] = createExportWrapper('lv_indev_get_user_data');
var _lv_indev_get_driver_data = Module['_lv_indev_get_driver_data'] = createExportWrapper('lv_indev_get_driver_data');
var _lv_indev_get_press_moved = Module['_lv_indev_get_press_moved'] = createExportWrapper('lv_indev_get_press_moved');
var _lv_indev_stop_processing = Module['_lv_indev_stop_processing'] = createExportWrapper('lv_indev_stop_processing');
...
var _lv_indev_get_mode = Module['_lv_indev_get_mode'] = createExportWrapper('lv_indev_get_mode');
var _lv_indev_set_mode = Module['_lv_indev_set_mode'] = createExportWrapper('lv_indev_set_mode');
...
var _lv_indev_add_event_cb = Module['_lv_indev_add_event_cb'] = createExportWrapper('lv_indev_add_event_cb');
var _lv_indev_get_event_count = Module['_lv_indev_get_event_count'] = createExportWrapper('lv_indev_get_event_count');
var _lv_indev_get_event_dsc = Module['_lv_indev_get_event_dsc'] = createExportWrapper('lv_indev_get_event_dsc');
var _lv_indev_remove_event = Module['_lv_indev_remove_event'] = createExportWrapper('lv_indev_remove_event');
var _lv_indev_remove_event_cb_with_user_data = Module['_lv_indev_remove_event_cb_with_user_data'] = createExportWrapper('lv_indev_remove_event_cb_with_user_data');
var _lv_indev_scroll_throw_handler = Module['_lv_indev_scroll_throw_handler'] = createExportWrapper('lv_indev_scroll_throw_handler');
var _lv_timer_get_paused = Module['_lv_timer_get_paused'] = createExportWrapper('lv_timer_get_paused');
var _lv_anim_set_repeat_count = Module['_lv_anim_set_repeat_count'] = createExportWrapper('lv_anim_set_repeat_count');
...
var _lv_grid_fr = Module['_lv_grid_fr'] = createExportWrapper('lv_grid_fr');
var _lv_layout_init = Module['_lv_layout_init'] = createExportWrapper('lv_layout_init');
var _lv_layout_deinit = Module['_lv_layout_deinit'] = createExportWrapper('lv_layout_deinit');
var _lv_layout_register = Module['_lv_layout_register'] = createExportWrapper('lv_layout_register');
var _lv_bin_decoder_init = Module['_lv_bin_decoder_init'] = createExportWrapper('lv_bin_decoder_init');
var _lv_bin_decoder_info = Module['_lv_bin_decoder_info'] = createExportWrapper('lv_bin_decoder_info');
var _lv_bin_decoder_open = Module['_lv_bin_decoder_open'] = createExportWrapper('lv_bin_decoder_open');
...
var _lv_span_stack_init = Module['_lv_span_stack_init'] = createExportWrapper('lv_span_stack_init');
var _lv_os_init = Module['_lv_os_init'] = createExportWrapper('lv_os_init');
var _lv_timer_core_init = Module['_lv_timer_core_init'] = createExportWrapper('lv_timer_core_init');
var _lv_fs_init = Module['_lv_fs_init'] = createExportWrapper('lv_fs_init');
var _lv_anim_core_init = Module['_lv_anim_core_init'] = createExportWrapper('lv_anim_core_init');
var _lv_color_to_u16 = Module['_lv_color_to_u16'] = createExportWrapper('lv_color_to_u16');
var _lv_color_16_16_mix = Module['_lv_color_16_16_mix'] = createExportWrapper('lv_color_16_16_mix');
var _lv_color_to_32 = Module['_lv_color_to_32'] = createExportWrapper('lv_color_to_32');
var _lv_color_mix32 = Module['_lv_color_mix32'] = createExportWrapper('lv_color_mix32');
var _lv_color32_eq = Module['_lv_color32_eq'] = createExportWrapper('lv_color32_eq');
var _lv_color_luminance = Module['_lv_color_luminance'] = createExportWrapper('lv_color_luminance');
var _lv_color32_luminance = Module['_lv_color32_luminance'] = createExportWrapper('lv_color32_luminance');
var _lv_color16_luminance = Module['_lv_color16_luminance'] = createExportWrapper('lv_color16_luminance');
var _lv_color24_luminance = Module['_lv_color24_luminance'] = createExportWrapper('lv_color24_luminance');
var _lv_color_make = Module['_lv_color_make'] = createExportWrapper('lv_color_make');
var _lv_trigo_cos = Module['_lv_trigo_cos'] = createExportWrapper('lv_trigo_cos');
var _lv_point_from_precise = Module['_lv_point_from_precise'] = createExportWrapper('lv_point_from_precise');
var _lv_point_swap = Module['_lv_point_swap'] = createExportWrapper('lv_point_swap');
var _lv_fs_get_ext = Module['_lv_fs_get_ext'] = createExportWrapper('lv_fs_get_ext');
var _lv_strcmp = Module['_lv_strcmp'] = createExportWrapper('lv_strcmp');
var _lv_snprintf = Module['_lv_snprintf'] = createExportWrapper('lv_snprintf');
var _lv_strlcpy = Module['_lv_strlcpy'] = createExportWrapper('lv_strlcpy');
var _lv_deinit = Module['_lv_deinit'] = createExportWrapper('lv_deinit');
var _lv_ll_clear_custom = Module['_lv_ll_clear_custom'] = createExportWrapper('lv_ll_clear_custom');
var _lv_span_stack_deinit = Module['_lv_span_stack_deinit'] = createExportWrapper('lv_span_stack_deinit');
var _lv_theme_default_deinit = Module['_lv_theme_default_deinit'] = createExportWrapper('lv_theme_default_deinit');
var _lv_theme_simple_deinit = Module['_lv_theme_simple_deinit'] = createExportWrapper('lv_theme_simple_deinit');
var _lv_theme_mono_deinit = Module['_lv_theme_mono_deinit'] = createExportWrapper('lv_theme_mono_deinit');
var _lv_anim_core_deinit = Module['_lv_anim_core_deinit'] = createExportWrapper('lv_anim_core_deinit');
var _lv_fs_deinit = Module['_lv_fs_deinit'] = createExportWrapper('lv_fs_deinit');
var _lv_timer_core_deinit = Module['_lv_timer_core_deinit'] = createExportWrapper('lv_timer_core_deinit');
...
var _lv_cache_create = Module['_lv_cache_create'] = createExportWrapper('lv_cache_create');
var _lv_cache_entry_acquire_data = Module['_lv_cache_entry_acquire_data'] = createExportWrapper('lv_cache_entry_acquire_data');
var _lv_cache_entry_release_data = Module['_lv_cache_entry_release_data'] = createExportWrapper('lv_cache_entry_release_data');
var _lv_cache_entry_get_ref = Module['_lv_cache_entry_get_ref'] = createExportWrapper('lv_cache_entry_get_ref');
var _lv_cache_entry_is_invalid = Module['_lv_cache_entry_is_invalid'] = createExportWrapper('lv_cache_entry_is_invalid');
var _lv_cache_entry_delete = Module['_lv_cache_entry_delete'] = createExportWrapper('lv_cache_entry_delete');
var _lv_cache_acquire_or_create = Module['_lv_cache_acquire_or_create'] = createExportWrapper('lv_cache_acquire_or_create');
var _lv_cache_reserve = Module['_lv_cache_reserve'] = createExportWrapper('lv_cache_reserve');
var _lv_cache_drop = Module['_lv_cache_drop'] = createExportWrapper('lv_cache_drop');
var _lv_cache_entry_set_invalid = Module['_lv_cache_entry_set_invalid'] = createExportWrapper('lv_cache_entry_set_invalid');
var _lv_cache_evict_one = Module['_lv_cache_evict_one'] = createExportWrapper('lv_cache_evict_one');
var _lv_cache_drop_all = Module['_lv_cache_drop_all'] = createExportWrapper('lv_cache_drop_all');
var _lv_cache_set_max_size = Module['_lv_cache_set_max_size'] = createExportWrapper('lv_cache_set_max_size');
var _lv_cache_get_max_size = Module['_lv_cache_get_max_size'] = createExportWrapper('lv_cache_get_max_size');
var _lv_cache_get_size = Module['_lv_cache_get_size'] = createExportWrapper('lv_cache_get_size');
var _lv_cache_get_free_size = Module['_lv_cache_get_free_size'] = createExportWrapper('lv_cache_get_free_size');
var _lv_cache_is_enabled = Module['_lv_cache_is_enabled'] = createExportWrapper('lv_cache_is_enabled');
var _lv_cache_set_compare_cb = Module['_lv_cache_set_compare_cb'] = createExportWrapper('lv_cache_set_compare_cb');
var _lv_cache_set_create_cb = Module['_lv_cache_set_create_cb'] = createExportWrapper('lv_cache_set_create_cb');
var _lv_cache_set_free_cb = Module['_lv_cache_set_free_cb'] = createExportWrapper('lv_cache_set_free_cb');
var _lv_cache_set_name = Module['_lv_cache_set_name'] = createExportWrapper('lv_cache_set_name');
var _lv_cache_get_name = Module['_lv_cache_get_name'] = createExportWrapper('lv_cache_get_name');
var _lv_cache_entry_reset_ref = Module['_lv_cache_entry_reset_ref'] = createExportWrapper('lv_cache_entry_reset_ref');
var _lv_cache_entry_inc_ref = Module['_lv_cache_entry_inc_ref'] = createExportWrapper('lv_cache_entry_inc_ref');
var _lv_cache_entry_dec_ref = Module['_lv_cache_entry_dec_ref'] = createExportWrapper('lv_cache_entry_dec_ref');
var _lv_cache_entry_get_node_size = Module['_lv_cache_entry_get_node_size'] = createExportWrapper('lv_cache_entry_get_node_size');
var _lv_cache_entry_set_node_size = Module['_lv_cache_entry_set_node_size'] = createExportWrapper('lv_cache_entry_set_node_size');
var _lv_cache_entry_get_entry = Module['_lv_cache_entry_get_entry'] = createExportWrapper('lv_cache_entry_get_entry');
var _lv_cache_entry_set_cache = Module['_lv_cache_entry_set_cache'] = createExportWrapper('lv_cache_entry_set_cache');
var _lv_cache_entry_get_cache = Module['_lv_cache_entry_get_cache'] = createExportWrapper('lv_cache_entry_get_cache');
var _lv_cache_entry_get_size = Module['_lv_cache_entry_get_size'] = createExportWrapper('lv_cache_entry_get_size');
var _lv_cache_entry_alloc = Module['_lv_cache_entry_alloc'] = createExportWrapper('lv_cache_entry_alloc');
var _lv_cache_entry_init = Module['_lv_cache_entry_init'] = createExportWrapper('lv_cache_entry_init');
var _lv_rb_init = Module['_lv_rb_init'] = createExportWrapper('lv_rb_init');
var _lv_rb_find = Module['_lv_rb_find'] = createExportWrapper('lv_rb_find');
var _lv_ll_move_before = Module['_lv_ll_move_before'] = createExportWrapper('lv_ll_move_before');
var _lv_rb_insert = Module['_lv_rb_insert'] = createExportWrapper('lv_rb_insert');
var _lv_rb_drop_node = Module['_lv_rb_drop_node'] = createExportWrapper('lv_rb_drop_node');
var _lv_rb_remove_node = Module['_lv_rb_remove_node'] = createExportWrapper('lv_rb_remove_node');
var _lv_rb_destroy = Module['_lv_rb_destroy'] = createExportWrapper('lv_rb_destroy');
var _lv_image_cache_resize = Module['_lv_image_cache_resize'] = createExportWrapper('lv_image_cache_resize');
var _lv_image_cache_drop = Module['_lv_image_cache_drop'] = createExportWrapper('lv_image_cache_drop');
var _lv_image_header_cache_drop = Module['_lv_image_header_cache_drop'] = createExportWrapper('lv_image_header_cache_drop');
var _lv_image_header_cache_resize = Module['_lv_image_header_cache_resize'] = createExportWrapper('lv_image_header_cache_resize');
var _lv_anim_delete_all = Module['_lv_anim_delete_all'] = createExportWrapper('lv_anim_delete_all');
...
var _lv_anim_speed = Module['_lv_anim_speed'] = createExportWrapper('lv_anim_speed');
...
var _lv_cubic_bezier = Module['_lv_cubic_bezier'] = createExportWrapper('lv_cubic_bezier');
...
var _lv_anim_path_custom_bezier3 = Module['_lv_anim_path_custom_bezier3'] = createExportWrapper('lv_anim_path_custom_bezier3');
var _lv_anim_set_time = Module['_lv_anim_set_time'] = createExportWrapper('lv_anim_set_time');
var _lv_anim_set_custom_exec_cb = Module['_lv_anim_set_custom_exec_cb'] = createExportWrapper('lv_anim_set_custom_exec_cb');
var _lv_anim_set_get_value_cb = Module['_lv_anim_set_get_value_cb'] = createExportWrapper('lv_anim_set_get_value_cb');
var _lv_anim_set_playback_duration = Module['_lv_anim_set_playback_duration'] = createExportWrapper('lv_anim_set_playback_duration');
var _lv_anim_set_playback_time = Module['_lv_anim_set_playback_time'] = createExportWrapper('lv_anim_set_playback_time');
var _lv_anim_set_playback_delay = Module['_lv_anim_set_playback_delay'] = createExportWrapper('lv_anim_set_playback_delay');
var _lv_anim_set_repeat_delay = Module['_lv_anim_set_repeat_delay'] = createExportWrapper('lv_anim_set_repeat_delay');
var _lv_anim_set_bezier3_param = Module['_lv_anim_set_bezier3_param'] = createExportWrapper('lv_anim_set_bezier3_param');
var _lv_anim_get_delay = Module['_lv_anim_get_delay'] = createExportWrapper('lv_anim_get_delay');
var _lv_anim_get_time = Module['_lv_anim_get_time'] = createExportWrapper('lv_anim_get_time');
var _lv_anim_get_repeat_count = Module['_lv_anim_get_repeat_count'] = createExportWrapper('lv_anim_get_repeat_count');
var _lv_anim_get_user_data = Module['_lv_anim_get_user_data'] = createExportWrapper('lv_anim_get_user_data');
var _lv_anim_custom_delete = Module['_lv_anim_custom_delete'] = createExportWrapper('lv_anim_custom_delete');
var _lv_anim_custom_get = Module['_lv_anim_custom_get'] = createExportWrapper('lv_anim_custom_get');
var _lv_anim_timeline_create = Module['_lv_anim_timeline_create'] = createExportWrapper('lv_anim_timeline_create');
var _lv_anim_timeline_delete = Module['_lv_anim_timeline_delete'] = createExportWrapper('lv_anim_timeline_delete');
var _lv_anim_timeline_pause = Module['_lv_anim_timeline_pause'] = createExportWrapper('lv_anim_timeline_pause');
...
var _lv_anim_timeline_set_repeat_count = Module['_lv_anim_timeline_set_repeat_count'] = createExportWrapper('lv_anim_timeline_set_repeat_count');
var _lv_anim_timeline_set_repeat_delay = Module['_lv_anim_timeline_set_repeat_delay'] = createExportWrapper('lv_anim_timeline_set_repeat_delay');
...
var _lv_anim_timeline_get_progress = Module['_lv_anim_timeline_get_progress'] = createExportWrapper('lv_anim_timeline_get_progress');
var _lv_anim_timeline_get_repeat_count = Module['_lv_anim_timeline_get_repeat_count'] = createExportWrapper('lv_anim_timeline_get_repeat_count');
var _lv_anim_timeline_get_repeat_delay = Module['_lv_anim_timeline_get_repeat_delay'] = createExportWrapper('lv_anim_timeline_get_repeat_delay');
var _lv_area_set_pos = Module['_lv_area_set_pos'] = createExportWrapper('lv_area_set_pos');
var _lv_area_is_equal = Module['_lv_area_is_equal'] = createExportWrapper('lv_area_is_equal');
var _lv_point_to_precise = Module['_lv_point_to_precise'] = createExportWrapper('lv_point_to_precise');
var _lv_point_precise_set = Module['_lv_point_precise_set'] = createExportWrapper('lv_point_precise_set');
var _lv_point_precise_swap = Module['_lv_point_precise_swap'] = createExportWrapper('lv_point_precise_swap');
var _lv_pct = Module['_lv_pct'] = createExportWrapper('lv_pct');
var _lv_pct_to_px = Module['_lv_pct_to_px'] = createExportWrapper('lv_pct_to_px');
var _lv_array_init = Module['_lv_array_init'] = createExportWrapper('lv_array_init');
var _lv_array_deinit = Module['_lv_array_deinit'] = createExportWrapper('lv_array_deinit');
var _lv_array_copy = Module['_lv_array_copy'] = createExportWrapper('lv_array_copy');
var _lv_array_is_empty = Module['_lv_array_is_empty'] = createExportWrapper('lv_array_is_empty');
var _lv_array_shrink = Module['_lv_array_shrink'] = createExportWrapper('lv_array_shrink');
var _lv_array_resize = Module['_lv_array_resize'] = createExportWrapper('lv_array_resize');
var _lv_array_remove = Module['_lv_array_remove'] = createExportWrapper('lv_array_remove');
var _lv_array_at = Module['_lv_array_at'] = createExportWrapper('lv_array_at');
var _lv_array_erase = Module['_lv_array_erase'] = createExportWrapper('lv_array_erase');
var _lv_array_concat = Module['_lv_array_concat'] = createExportWrapper('lv_array_concat');
var _lv_array_push_back = Module['_lv_array_push_back'] = createExportWrapper('lv_array_push_back');
var _lv_array_assign = Module['_lv_array_assign'] = createExportWrapper('lv_array_assign');
var _lv_array_size = Module['_lv_array_size'] = createExportWrapper('lv_array_size');
var _lv_array_capacity = Module['_lv_array_capacity'] = createExportWrapper('lv_array_capacity');
var _lv_array_is_full = Module['_lv_array_is_full'] = createExportWrapper('lv_array_is_full');
var _lv_array_clear = Module['_lv_array_clear'] = createExportWrapper('lv_array_clear');
var _lv_array_front = Module['_lv_array_front'] = createExportWrapper('lv_array_front');
var _lv_array_back = Module['_lv_array_back'] = createExportWrapper('lv_array_back');
...
var _lv_bidi_process = Module['_lv_bidi_process'] = createExportWrapper('lv_bidi_process');
var _lv_bidi_detect_base_dir = Module['_lv_bidi_detect_base_dir'] = createExportWrapper('lv_bidi_detect_base_dir');
var _lv_bidi_get_visual_pos = Module['_lv_bidi_get_visual_pos'] = createExportWrapper('lv_bidi_get_visual_pos');
var _lv_bidi_set_custom_neutrals_static = Module['_lv_bidi_set_custom_neutrals_static'] = createExportWrapper('lv_bidi_set_custom_neutrals_static');
...
var _lv_color_to_int = Module['_lv_color_to_int'] = createExportWrapper('lv_color_to_int');
var _lv_color32_make = Module['_lv_color32_make'] = createExportWrapper('lv_color32_make');
var _lv_color_hex3 = Module['_lv_color_hex3'] = createExportWrapper('lv_color_hex3');
var _lv_color_brightness = Module['_lv_color_brightness'] = createExportWrapper('lv_color_brightness');
var _lv_color_filter_dsc_init = Module['_lv_color_filter_dsc_init'] = createExportWrapper('lv_color_filter_dsc_init');
var _lv_event_dsc_get_cb = Module['_lv_event_dsc_get_cb'] = createExportWrapper('lv_event_dsc_get_cb');
var _lv_event_dsc_get_user_data = Module['_lv_event_dsc_get_user_data'] = createExportWrapper('lv_event_dsc_get_user_data');
...
var _lv_fs_make_path_from_buffer = Module['_lv_fs_make_path_from_buffer'] = createExportWrapper('lv_fs_make_path_from_buffer');
...
var _lv_strlen = Module['_lv_strlen'] = createExportWrapper('lv_strlen');
...
var _lv_ll_chg_list = Module['_lv_ll_chg_list'] = createExportWrapper('lv_ll_chg_list');
...
var _lv_lru_delete = Module['_lv_lru_delete'] = createExportWrapper('lv_lru_delete');
...
var _lv_sqrt32 = Module['_lv_sqrt32'] = createExportWrapper('lv_sqrt32');
...
var _lv_rb_minimum_from = Module['_lv_rb_minimum_from'] = createExportWrapper('lv_rb_minimum_from');
var _lv_rb_remove = Module['_lv_rb_remove'] = createExportWrapper('lv_rb_remove');
var _lv_rb_drop = Module['_lv_rb_drop'] = createExportWrapper('lv_rb_drop');
var _lv_rb_minimum = Module['_lv_rb_minimum'] = createExportWrapper('lv_rb_minimum');
var _lv_rb_maximum = Module['_lv_rb_maximum'] = createExportWrapper('lv_rb_maximum');
var _lv_rb_maximum_from = Module['_lv_rb_maximum_from'] = createExportWrapper('lv_rb_maximum_from');
...
var _lv_style_set_length = Module['_lv_style_set_length'] = createExportWrapper('lv_style_set_length');
...
var _lv_style_set_transform_scale_x = Module['_lv_style_set_transform_scale_x'] = createExportWrapper('lv_style_set_transform_scale_x');
var _lv_style_set_transform_scale_y = Module['_lv_style_set_transform_scale_y'] = createExportWrapper('lv_style_set_transform_scale_y');
var _lv_style_set_transform_rotation = Module['_lv_style_set_transform_rotation'] = createExportWrapper('lv_style_set_transform_rotation');
...
var _lv_style_set_transform_skew_x = Module['_lv_style_set_transform_skew_x'] = createExportWrapper('lv_style_set_transform_skew_x');
var _lv_style_set_transform_skew_y = Module['_lv_style_set_transform_skew_y'] = createExportWrapper('lv_style_set_transform_skew_y');
...
var _lv_style_set_margin_top = Module['_lv_style_set_margin_top'] = createExportWrapper('lv_style_set_margin_top');
var _lv_style_set_margin_bottom = Module['_lv_style_set_margin_bottom'] = createExportWrapper('lv_style_set_margin_bottom');
var _lv_style_set_margin_left = Module['_lv_style_set_margin_left'] = createExportWrapper('lv_style_set_margin_left');
var _lv_style_set_margin_right = Module['_lv_style_set_margin_right'] = createExportWrapper('lv_style_set_margin_right');
...
var _lv_style_set_bg_main_opa = Module['_lv_style_set_bg_main_opa'] = createExportWrapper('lv_style_set_bg_main_opa');
var _lv_style_set_bg_grad_opa = Module['_lv_style_set_bg_grad_opa'] = createExportWrapper('lv_style_set_bg_grad_opa');
var _lv_style_set_bg_grad = Module['_lv_style_set_bg_grad'] = createExportWrapper('lv_style_set_bg_grad');
var _lv_style_set_bg_image_src = Module['_lv_style_set_bg_image_src'] = createExportWrapper('lv_style_set_bg_image_src');
var _lv_style_set_bg_image_opa = Module['_lv_style_set_bg_image_opa'] = createExportWrapper('lv_style_set_bg_image_opa');
var _lv_style_set_bg_image_recolor = Module['_lv_style_set_bg_image_recolor'] = createExportWrapper('lv_style_set_bg_image_recolor');
var _lv_style_set_bg_image_recolor_opa = Module['_lv_style_set_bg_image_recolor_opa'] = createExportWrapper('lv_style_set_bg_image_recolor_opa');
var _lv_style_set_bg_image_tiled = Module['_lv_style_set_bg_image_tiled'] = createExportWrapper('lv_style_set_bg_image_tiled');
...
var _lv_style_set_shadow_offset_x = Module['_lv_style_set_shadow_offset_x'] = createExportWrapper('lv_style_set_shadow_offset_x');
var _lv_style_set_shadow_offset_y = Module['_lv_style_set_shadow_offset_y'] = createExportWrapper('lv_style_set_shadow_offset_y');
...
var _lv_style_set_image_opa = Module['_lv_style_set_image_opa'] = createExportWrapper('lv_style_set_image_opa');
var _lv_style_set_image_recolor = Module['_lv_style_set_image_recolor'] = createExportWrapper('lv_style_set_image_recolor');
var _lv_style_set_image_recolor_opa = Module['_lv_style_set_image_recolor_opa'] = createExportWrapper('lv_style_set_image_recolor_opa');
...
var _lv_style_set_arc_image_src = Module['_lv_style_set_arc_image_src'] = createExportWrapper('lv_style_set_arc_image_src');
...
var _lv_style_set_anim_duration = Module['_lv_style_set_anim_duration'] = createExportWrapper('lv_style_set_anim_duration');
...
var _lv_style_set_bitmap_mask_src = Module['_lv_style_set_bitmap_mask_src'] = createExportWrapper('lv_style_set_bitmap_mask_src');
var _lv_style_set_rotary_sensitivity = Module['_lv_style_set_rotary_sensitivity'] = createExportWrapper('lv_style_set_rotary_sensitivity');
...
var _lv_text_ins = Module['_lv_text_ins'] = createExportWrapper('lv_text_ins');
var _lv_text_cut = Module['_lv_text_cut'] = createExportWrapper('lv_text_cut');
var _lv_text_set_text_vfmt = Module['_lv_text_set_text_vfmt'] = createExportWrapper('lv_text_set_text_vfmt');
var _lv_text_ap_calc_bytes_count = Module['_lv_text_ap_calc_bytes_count'] = createExportWrapper('lv_text_ap_calc_bytes_count');
var _lv_text_ap_proc = Module['_lv_text_ap_proc'] = createExportWrapper('lv_text_ap_proc');
var _lv_timer_enable = Module['_lv_timer_enable'] = createExportWrapper('lv_timer_enable');
var _lv_lock = Module['_lv_lock'] = createExportWrapper('lv_lock');
var _lv_unlock = Module['_lv_unlock'] = createExportWrapper('lv_unlock');
var _lv_timer_periodic_handler = Module['_lv_timer_periodic_handler'] = createExportWrapper('lv_timer_periodic_handler');
...
var _lv_timer_set_auto_delete = Module['_lv_timer_set_auto_delete'] = createExportWrapper('lv_timer_set_auto_delete');
var _lv_timer_set_user_data = Module['_lv_timer_set_user_data'] = createExportWrapper('lv_timer_set_user_data');
...
var _lv_timer_get_time_until_next = Module['_lv_timer_get_time_until_next'] = createExportWrapper('lv_timer_get_time_until_next');
var _lv_timer_handler_run_in_period = Module['_lv_timer_handler_run_in_period'] = createExportWrapper('lv_timer_handler_run_in_period');
var _lv_timer_get_user_data = Module['_lv_timer_get_user_data'] = createExportWrapper('lv_timer_get_user_data');
var _lv_timer_handler_set_resume_cb = Module['_lv_timer_handler_set_resume_cb'] = createExportWrapper('lv_timer_handler_set_resume_cb');
var _lv_draw_buf_save_to_file = Module['_lv_draw_buf_save_to_file'] = createExportWrapper('lv_draw_buf_save_to_file');
var _lv_lock_isr = Module['_lv_lock_isr'] = createExportWrapper('lv_lock_isr');
var _lv_thread_init = Module['_lv_thread_init'] = createExportWrapper('lv_thread_init');
var _lv_thread_delete = Module['_lv_thread_delete'] = createExportWrapper('lv_thread_delete');
var _lv_mutex_lock_isr = Module['_lv_mutex_lock_isr'] = createExportWrapper('lv_mutex_lock_isr');
var _lv_thread_sync_init = Module['_lv_thread_sync_init'] = createExportWrapper('lv_thread_sync_init');
var _lv_thread_sync_wait = Module['_lv_thread_sync_wait'] = createExportWrapper('lv_thread_sync_wait');
var _lv_thread_sync_signal = Module['_lv_thread_sync_signal'] = createExportWrapper('lv_thread_sync_signal');
var _lv_thread_sync_signal_isr = Module['_lv_thread_sync_signal_isr'] = createExportWrapper('lv_thread_sync_signal_isr');
var _lv_thread_sync_delete = Module['_lv_thread_sync_delete'] = createExportWrapper('lv_thread_sync_delete');
...
var _lv_subject_init_int = Module['_lv_subject_init_int'] = createExportWrapper('lv_subject_init_int');
var _lv_subject_set_int = Module['_lv_subject_set_int'] = createExportWrapper('lv_subject_set_int');
var _lv_subject_notify = Module['_lv_subject_notify'] = createExportWrapper('lv_subject_notify');
var _lv_subject_get_int = Module['_lv_subject_get_int'] = createExportWrapper('lv_subject_get_int');
var _lv_subject_get_previous_int = Module['_lv_subject_get_previous_int'] = createExportWrapper('lv_subject_get_previous_int');
var _lv_subject_init_string = Module['_lv_subject_init_string'] = createExportWrapper('lv_subject_init_string');
var _lv_subject_copy_string = Module['_lv_subject_copy_string'] = createExportWrapper('lv_subject_copy_string');
var _lv_subject_get_string = Module['_lv_subject_get_string'] = createExportWrapper('lv_subject_get_string');
var _lv_subject_get_previous_string = Module['_lv_subject_get_previous_string'] = createExportWrapper('lv_subject_get_previous_string');
var _lv_subject_init_pointer = Module['_lv_subject_init_pointer'] = createExportWrapper('lv_subject_init_pointer');
var _lv_subject_set_pointer = Module['_lv_subject_set_pointer'] = createExportWrapper('lv_subject_set_pointer');
var _lv_subject_get_pointer = Module['_lv_subject_get_pointer'] = createExportWrapper('lv_subject_get_pointer');
var _lv_subject_get_previous_pointer = Module['_lv_subject_get_previous_pointer'] = createExportWrapper('lv_subject_get_previous_pointer');
var _lv_subject_init_color = Module['_lv_subject_init_color'] = createExportWrapper('lv_subject_init_color');
var _lv_subject_set_color = Module['_lv_subject_set_color'] = createExportWrapper('lv_subject_set_color');
var _lv_subject_get_color = Module['_lv_subject_get_color'] = createExportWrapper('lv_subject_get_color');
var _lv_subject_get_previous_color = Module['_lv_subject_get_previous_color'] = createExportWrapper('lv_subject_get_previous_color');
var _lv_subject_init_group = Module['_lv_subject_init_group'] = createExportWrapper('lv_subject_init_group');
var _lv_subject_add_observer_obj = Module['_lv_subject_add_observer_obj'] = createExportWrapper('lv_subject_add_observer_obj');
var _lv_subject_add_observer = Module['_lv_subject_add_observer'] = createExportWrapper('lv_subject_add_observer');
var _lv_subject_deinit = Module['_lv_subject_deinit'] = createExportWrapper('lv_subject_deinit');
var _lv_observer_remove = Module['_lv_observer_remove'] = createExportWrapper('lv_observer_remove');
var _lv_subject_get_group_element = Module['_lv_subject_get_group_element'] = createExportWrapper('lv_subject_get_group_element');
var _lv_subject_add_observer_with_target = Module['_lv_subject_add_observer_with_target'] = createExportWrapper('lv_subject_add_observer_with_target');
var _lv_obj_remove_from_subject = Module['_lv_obj_remove_from_subject'] = createExportWrapper('lv_obj_remove_from_subject');
var _lv_observer_get_target = Module['_lv_observer_get_target'] = createExportWrapper('lv_observer_get_target');
var _lv_obj_bind_flag_if_eq = Module['_lv_obj_bind_flag_if_eq'] = createExportWrapper('lv_obj_bind_flag_if_eq');
var _lv_obj_bind_flag_if_not_eq = Module['_lv_obj_bind_flag_if_not_eq'] = createExportWrapper('lv_obj_bind_flag_if_not_eq');
var _lv_obj_bind_state_if_eq = Module['_lv_obj_bind_state_if_eq'] = createExportWrapper('lv_obj_bind_state_if_eq');
var _lv_obj_bind_state_if_not_eq = Module['_lv_obj_bind_state_if_not_eq'] = createExportWrapper('lv_obj_bind_state_if_not_eq');
var _lv_obj_bind_checked = Module['_lv_obj_bind_checked'] = createExportWrapper('lv_obj_bind_checked');
var _lv_label_bind_text = Module['_lv_label_bind_text'] = createExportWrapper('lv_label_bind_text');
var _lv_arc_bind_value = Module['_lv_arc_bind_value'] = createExportWrapper('lv_arc_bind_value');
var _lv_slider_bind_value = Module['_lv_slider_bind_value'] = createExportWrapper('lv_slider_bind_value');
var _lv_roller_bind_value = Module['_lv_roller_bind_value'] = createExportWrapper('lv_roller_bind_value');
var _lv_dropdown_bind_value = Module['_lv_dropdown_bind_value'] = createExportWrapper('lv_dropdown_bind_value');
var _lv_observer_get_target_obj = Module['_lv_observer_get_target_obj'] = createExportWrapper('lv_observer_get_target_obj');
var _lv_observer_get_user_data = Module['_lv_observer_get_user_data'] = createExportWrapper('lv_observer_get_user_data');
...
var _lv_mem_add_pool = Module['_lv_mem_add_pool'] = createExportWrapper('lv_mem_add_pool');
var _lv_tlsf_add_pool = Module['_lv_tlsf_add_pool'] = createExportWrapper('lv_tlsf_add_pool');
var _lv_mem_remove_pool = Module['_lv_mem_remove_pool'] = createExportWrapper('lv_mem_remove_pool');
var _lv_tlsf_remove_pool = Module['_lv_tlsf_remove_pool'] = createExportWrapper('lv_tlsf_remove_pool');
var _lv_malloc_core = Module['_lv_malloc_core'] = createExportWrapper('lv_malloc_core');
...
var _lv_realloc_core = Module['_lv_realloc_core'] = createExportWrapper('lv_realloc_core');
var _lv_tlsf_realloc = Module['_lv_tlsf_realloc'] = createExportWrapper('lv_tlsf_realloc');
var _lv_free_core = Module['_lv_free_core'] = createExportWrapper('lv_free_core');
var _lv_tlsf_free = Module['_lv_tlsf_free'] = createExportWrapper('lv_tlsf_free');
var _lv_mem_monitor_core = Module['_lv_mem_monitor_core'] = createExportWrapper('lv_mem_monitor_core');
var _lv_tlsf_walk_pool = Module['_lv_tlsf_walk_pool'] = createExportWrapper('lv_tlsf_walk_pool');
var _lv_mem_test_core = Module['_lv_mem_test_core'] = createExportWrapper('lv_mem_test_core');
...
var _lv_strncpy = Module['_lv_strncpy'] = createExportWrapper('lv_strncpy');
var _lv_strcpy = Module['_lv_strcpy'] = createExportWrapper('lv_strcpy');
var _lv_strcat = Module['_lv_strcat'] = createExportWrapper('lv_strcat');
var _lv_strncat = Module['_lv_strncat'] = createExportWrapper('lv_strncat');
...
var _lv_theme_simple_is_inited = Module['_lv_theme_simple_is_inited'] = createExportWrapper('lv_theme_simple_is_inited');
var _lv_theme_simple_get = Module['_lv_theme_simple_get'] = createExportWrapper('lv_theme_simple_get');
var _lv_theme_simple_init = Module['_lv_theme_simple_init'] = createExportWrapper('lv_theme_simple_init');
var _lv_delay_ms = Module['_lv_delay_ms'] = createExportWrapper('lv_delay_ms');
var _lv_tick_set_cb = Module['_lv_tick_set_cb'] = createExportWrapper('lv_tick_set_cb');
var _lv_delay_set_cb = Module['_lv_delay_set_cb'] = createExportWrapper('lv_delay_set_cb');
...
var _lv_animimg_get_src = Module['_lv_animimg_get_src'] = createExportWrapper('lv_animimg_get_src');
var _lv_animimg_get_src_count = Module['_lv_animimg_get_src_count'] = createExportWrapper('lv_animimg_get_src_count');
var _lv_animimg_get_duration = Module['_lv_animimg_get_duration'] = createExportWrapper('lv_animimg_get_duration');
var _lv_animimg_get_repeat_count = Module['_lv_animimg_get_repeat_count'] = createExportWrapper('lv_animimg_get_repeat_count');
var _lv_animimg_get_anim = Module['_lv_animimg_get_anim'] = createExportWrapper('lv_animimg_get_anim');
...
var _lv_arc_set_knob_offset = Module['_lv_arc_set_knob_offset'] = createExportWrapper('lv_arc_set_knob_offset');
...
var _lv_arc_get_rotation = Module['_lv_arc_get_rotation'] = createExportWrapper('lv_arc_get_rotation');
var _lv_arc_get_knob_offset = Module['_lv_arc_get_knob_offset'] = createExportWrapper('lv_arc_get_knob_offset');
...
var _lv_bar_set_orientation = Module['_lv_bar_set_orientation'] = createExportWrapper('lv_bar_set_orientation');
...
var _lv_bar_get_orientation = Module['_lv_bar_get_orientation'] = createExportWrapper('lv_bar_get_orientation');
var _lv_bar_is_symmetrical = Module['_lv_bar_is_symmetrical'] = createExportWrapper('lv_bar_is_symmetrical');
var _lv_buttonmatrix_set_map = Module['_lv_buttonmatrix_set_map'] = createExportWrapper('lv_buttonmatrix_set_map');
var _lv_buttonmatrix_create = Module['_lv_buttonmatrix_create'] = createExportWrapper('lv_buttonmatrix_create');
var _lv_buttonmatrix_set_ctrl_map = Module['_lv_buttonmatrix_set_ctrl_map'] = createExportWrapper('lv_buttonmatrix_set_ctrl_map');
var _lv_buttonmatrix_set_selected_button = Module['_lv_buttonmatrix_set_selected_button'] = createExportWrapper('lv_buttonmatrix_set_selected_button');
var _lv_buttonmatrix_set_button_ctrl = Module['_lv_buttonmatrix_set_button_ctrl'] = createExportWrapper('lv_buttonmatrix_set_button_ctrl');
var _lv_buttonmatrix_clear_button_ctrl_all = Module['_lv_buttonmatrix_clear_button_ctrl_all'] = createExportWrapper('lv_buttonmatrix_clear_button_ctrl_all');
var _lv_buttonmatrix_clear_button_ctrl = Module['_lv_buttonmatrix_clear_button_ctrl'] = createExportWrapper('lv_buttonmatrix_clear_button_ctrl');
var _lv_buttonmatrix_set_button_ctrl_all = Module['_lv_buttonmatrix_set_button_ctrl_all'] = createExportWrapper('lv_buttonmatrix_set_button_ctrl_all');
var _lv_buttonmatrix_set_button_width = Module['_lv_buttonmatrix_set_button_width'] = createExportWrapper('lv_buttonmatrix_set_button_width');
var _lv_buttonmatrix_set_one_checked = Module['_lv_buttonmatrix_set_one_checked'] = createExportWrapper('lv_buttonmatrix_set_one_checked');
var _lv_buttonmatrix_get_map = Module['_lv_buttonmatrix_get_map'] = createExportWrapper('lv_buttonmatrix_get_map');
var _lv_buttonmatrix_get_selected_button = Module['_lv_buttonmatrix_get_selected_button'] = createExportWrapper('lv_buttonmatrix_get_selected_button');
var _lv_buttonmatrix_get_button_text = Module['_lv_buttonmatrix_get_button_text'] = createExportWrapper('lv_buttonmatrix_get_button_text');
var _lv_buttonmatrix_has_button_ctrl = Module['_lv_buttonmatrix_has_button_ctrl'] = createExportWrapper('lv_buttonmatrix_has_button_ctrl');
var _lv_buttonmatrix_get_one_checked = Module['_lv_buttonmatrix_get_one_checked'] = createExportWrapper('lv_buttonmatrix_get_one_checked');
...
var _lv_canvas_set_draw_buf = Module['_lv_canvas_set_draw_buf'] = createExportWrapper('lv_canvas_set_draw_buf');
var _lv_canvas_set_px = Module['_lv_canvas_set_px'] = createExportWrapper('lv_canvas_set_px');
var _lv_canvas_set_palette = Module['_lv_canvas_set_palette'] = createExportWrapper('lv_canvas_set_palette');
var _lv_canvas_get_draw_buf = Module['_lv_canvas_get_draw_buf'] = createExportWrapper('lv_canvas_get_draw_buf');
var _lv_canvas_get_px = Module['_lv_canvas_get_px'] = createExportWrapper('lv_canvas_get_px');
var _lv_canvas_get_image = Module['_lv_canvas_get_image'] = createExportWrapper('lv_canvas_get_image');
var _lv_canvas_get_buf = Module['_lv_canvas_get_buf'] = createExportWrapper('lv_canvas_get_buf');
...
var _lv_canvas_init_layer = Module['_lv_canvas_init_layer'] = createExportWrapper('lv_canvas_init_layer');
var _lv_canvas_finish_layer = Module['_lv_canvas_finish_layer'] = createExportWrapper('lv_canvas_finish_layer');
var _lv_canvas_buf_size = Module['_lv_canvas_buf_size'] = createExportWrapper('lv_canvas_buf_size');
...
var _lv_chart_get_series_color = Module['_lv_chart_get_series_color'] = createExportWrapper('lv_chart_get_series_color');
...
var _lv_chart_get_first_point_center_offset = Module['_lv_chart_get_first_point_center_offset'] = createExportWrapper('lv_chart_get_first_point_center_offset');
...
var _lv_dropdown_get_option_count = Module['_lv_dropdown_get_option_count'] = createExportWrapper('lv_dropdown_get_option_count');
...
var _lv_image_set_src = Module['_lv_image_set_src'] = createExportWrapper('lv_image_set_src');
var _lv_image_get_pivot = Module['_lv_image_get_pivot'] = createExportWrapper('lv_image_get_pivot');
var _lv_image_set_rotation = Module['_lv_image_set_rotation'] = createExportWrapper('lv_image_set_rotation');
var _lv_image_set_pivot = Module['_lv_image_set_pivot'] = createExportWrapper('lv_image_set_pivot');
var _lv_image_set_offset_x = Module['_lv_image_set_offset_x'] = createExportWrapper('lv_image_set_offset_x');
var _lv_image_set_offset_y = Module['_lv_image_set_offset_y'] = createExportWrapper('lv_image_set_offset_y');
var _lv_image_set_scale = Module['_lv_image_set_scale'] = createExportWrapper('lv_image_set_scale');
var _lv_image_set_scale_x = Module['_lv_image_set_scale_x'] = createExportWrapper('lv_image_set_scale_x');
var _lv_image_set_scale_y = Module['_lv_image_set_scale_y'] = createExportWrapper('lv_image_set_scale_y');
var _lv_image_set_blend_mode = Module['_lv_image_set_blend_mode'] = createExportWrapper('lv_image_set_blend_mode');
var _lv_image_set_antialias = Module['_lv_image_set_antialias'] = createExportWrapper('lv_image_set_antialias');
var _lv_image_set_inner_align = Module['_lv_image_set_inner_align'] = createExportWrapper('lv_image_set_inner_align');
var _lv_image_set_bitmap_map_src = Module['_lv_image_set_bitmap_map_src'] = createExportWrapper('lv_image_set_bitmap_map_src');
var _lv_image_get_src = Module['_lv_image_get_src'] = createExportWrapper('lv_image_get_src');
var _lv_image_get_offset_x = Module['_lv_image_get_offset_x'] = createExportWrapper('lv_image_get_offset_x');
var _lv_image_get_offset_y = Module['_lv_image_get_offset_y'] = createExportWrapper('lv_image_get_offset_y');
var _lv_image_get_rotation = Module['_lv_image_get_rotation'] = createExportWrapper('lv_image_get_rotation');
var _lv_image_get_scale = Module['_lv_image_get_scale'] = createExportWrapper('lv_image_get_scale');
var _lv_image_get_scale_x = Module['_lv_image_get_scale_x'] = createExportWrapper('lv_image_get_scale_x');
var _lv_image_get_scale_y = Module['_lv_image_get_scale_y'] = createExportWrapper('lv_image_get_scale_y');
var _lv_image_get_blend_mode = Module['_lv_image_get_blend_mode'] = createExportWrapper('lv_image_get_blend_mode');
var _lv_image_get_antialias = Module['_lv_image_get_antialias'] = createExportWrapper('lv_image_get_antialias');
var _lv_image_get_inner_align = Module['_lv_image_get_inner_align'] = createExportWrapper('lv_image_get_inner_align');
var _lv_image_get_bitmap_map_src = Module['_lv_image_get_bitmap_map_src'] = createExportWrapper('lv_image_get_bitmap_map_src');
var _lv_imagebutton_create = Module['_lv_imagebutton_create'] = createExportWrapper('lv_imagebutton_create');
var _lv_imagebutton_set_src = Module['_lv_imagebutton_set_src'] = createExportWrapper('lv_imagebutton_set_src');
var _lv_imagebutton_set_state = Module['_lv_imagebutton_set_state'] = createExportWrapper('lv_imagebutton_set_state');
var _lv_imagebutton_get_src_left = Module['_lv_imagebutton_get_src_left'] = createExportWrapper('lv_imagebutton_get_src_left');
var _lv_imagebutton_get_src_middle = Module['_lv_imagebutton_get_src_middle'] = createExportWrapper('lv_imagebutton_get_src_middle');
var _lv_imagebutton_get_src_right = Module['_lv_imagebutton_get_src_right'] = createExportWrapper('lv_imagebutton_get_src_right');
...
var _lv_keyboard_get_popovers = Module['_lv_keyboard_get_popovers'] = createExportWrapper('lv_keyboard_get_popovers');
...
var _lv_textarea_delete_char = Module['_lv_textarea_delete_char'] = createExportWrapper('lv_textarea_delete_char');
...
var _lv_keyboard_get_map_array = Module['_lv_keyboard_get_map_array'] = createExportWrapper('lv_keyboard_get_map_array');
var _lv_keyboard_get_selected_button = Module['_lv_keyboard_get_selected_button'] = createExportWrapper('lv_keyboard_get_selected_button');
var _lv_keyboard_get_button_text = Module['_lv_keyboard_get_button_text'] = createExportWrapper('lv_keyboard_get_button_text');
...
var _lv_label_set_text_selection_start = Module['_lv_label_set_text_selection_start'] = createExportWrapper('lv_label_set_text_selection_start');
var _lv_label_set_text_selection_end = Module['_lv_label_set_text_selection_end'] = createExportWrapper('lv_label_set_text_selection_end');
...
var _lv_line_set_points_mutable = Module['_lv_line_set_points_mutable'] = createExportWrapper('lv_line_set_points_mutable');
var _lv_line_set_y_invert = Module['_lv_line_set_y_invert'] = createExportWrapper('lv_line_set_y_invert');
var _lv_line_get_points = Module['_lv_line_get_points'] = createExportWrapper('lv_line_get_points');
var _lv_line_get_point_count = Module['_lv_line_get_point_count'] = createExportWrapper('lv_line_get_point_count');
var _lv_line_is_point_array_mutable = Module['_lv_line_is_point_array_mutable'] = createExportWrapper('lv_line_is_point_array_mutable');
var _lv_line_get_points_mutable = Module['_lv_line_get_points_mutable'] = createExportWrapper('lv_line_get_points_mutable');
...
var _lv_list_add_button = Module['_lv_list_add_button'] = createExportWrapper('lv_list_add_button');
var _lv_list_get_button_text = Module['_lv_list_get_button_text'] = createExportWrapper('lv_list_get_button_text');
var _lv_list_set_button_text = Module['_lv_list_set_button_text'] = createExportWrapper('lv_list_set_button_text');
...
var _lv_menu_set_page_title = Module['_lv_menu_set_page_title'] = createExportWrapper('lv_menu_set_page_title');
...
var _lv_menu_set_mode_root_back_button = Module['_lv_menu_set_mode_root_back_button'] = createExportWrapper('lv_menu_set_mode_root_back_button');
var _lv_menu_set_load_page_event = Module['_lv_menu_set_load_page_event'] = createExportWrapper('lv_menu_set_load_page_event');
var _lv_menu_set_page_title_static = Module['_lv_menu_set_page_title_static'] = createExportWrapper('lv_menu_set_page_title_static');
...
var _lv_menu_get_main_header_back_button = Module['_lv_menu_get_main_header_back_button'] = createExportWrapper('lv_menu_get_main_header_back_button');
var _lv_menu_get_sidebar_header = Module['_lv_menu_get_sidebar_header'] = createExportWrapper('lv_menu_get_sidebar_header');
var _lv_menu_get_sidebar_header_back_button = Module['_lv_menu_get_sidebar_header_back_button'] = createExportWrapper('lv_menu_get_sidebar_header_back_button');
var _lv_menu_back_button_is_root = Module['_lv_menu_back_button_is_root'] = createExportWrapper('lv_menu_back_button_is_root');
var _lv_msgbox_create = Module['_lv_msgbox_create'] = createExportWrapper('lv_msgbox_create');
var _lv_msgbox_add_title = Module['_lv_msgbox_add_title'] = createExportWrapper('lv_msgbox_add_title');
var _lv_msgbox_add_header_button = Module['_lv_msgbox_add_header_button'] = createExportWrapper('lv_msgbox_add_header_button');
var _lv_msgbox_add_text = Module['_lv_msgbox_add_text'] = createExportWrapper('lv_msgbox_add_text');
var _lv_msgbox_add_footer_button = Module['_lv_msgbox_add_footer_button'] = createExportWrapper('lv_msgbox_add_footer_button');
var _lv_msgbox_add_close_button = Module['_lv_msgbox_add_close_button'] = createExportWrapper('lv_msgbox_add_close_button');
var _lv_msgbox_get_header = Module['_lv_msgbox_get_header'] = createExportWrapper('lv_msgbox_get_header');
var _lv_msgbox_get_footer = Module['_lv_msgbox_get_footer'] = createExportWrapper('lv_msgbox_get_footer');
...
var _lv_roller_get_option_count = Module['_lv_roller_get_option_count'] = createExportWrapper('lv_roller_get_option_count');
var _lv_scale_set_mode = Module['_lv_scale_set_mode'] = createExportWrapper('lv_scale_set_mode');
var _lv_scale_set_total_tick_count = Module['_lv_scale_set_total_tick_count'] = createExportWrapper('lv_scale_set_total_tick_count');
var _lv_scale_set_major_tick_every = Module['_lv_scale_set_major_tick_every'] = createExportWrapper('lv_scale_set_major_tick_every');
var _lv_scale_set_label_show = Module['_lv_scale_set_label_show'] = createExportWrapper('lv_scale_set_label_show');
var _lv_scale_set_range = Module['_lv_scale_set_range'] = createExportWrapper('lv_scale_set_range');
var _lv_scale_set_angle_range = Module['_lv_scale_set_angle_range'] = createExportWrapper('lv_scale_set_angle_range');
var _lv_scale_set_rotation = Module['_lv_scale_set_rotation'] = createExportWrapper('lv_scale_set_rotation');
var _lv_scale_set_line_needle_value = Module['_lv_scale_set_line_needle_value'] = createExportWrapper('lv_scale_set_line_needle_value');
var _lv_scale_set_image_needle_value = Module['_lv_scale_set_image_needle_value'] = createExportWrapper('lv_scale_set_image_needle_value');
var _lv_scale_set_text_src = Module['_lv_scale_set_text_src'] = createExportWrapper('lv_scale_set_text_src');
var _lv_scale_set_post_draw = Module['_lv_scale_set_post_draw'] = createExportWrapper('lv_scale_set_post_draw');
var _lv_scale_set_draw_ticks_on_top = Module['_lv_scale_set_draw_ticks_on_top'] = createExportWrapper('lv_scale_set_draw_ticks_on_top');
var _lv_scale_add_section = Module['_lv_scale_add_section'] = createExportWrapper('lv_scale_add_section');
var _lv_scale_section_set_range = Module['_lv_scale_section_set_range'] = createExportWrapper('lv_scale_section_set_range');
var _lv_scale_section_set_style = Module['_lv_scale_section_set_style'] = createExportWrapper('lv_scale_section_set_style');
var _lv_scale_get_mode = Module['_lv_scale_get_mode'] = createExportWrapper('lv_scale_get_mode');
var _lv_scale_get_total_tick_count = Module['_lv_scale_get_total_tick_count'] = createExportWrapper('lv_scale_get_total_tick_count');
var _lv_scale_get_major_tick_every = Module['_lv_scale_get_major_tick_every'] = createExportWrapper('lv_scale_get_major_tick_every');
var _lv_scale_get_label_show = Module['_lv_scale_get_label_show'] = createExportWrapper('lv_scale_get_label_show');
var _lv_scale_get_angle_range = Module['_lv_scale_get_angle_range'] = createExportWrapper('lv_scale_get_angle_range');
var _lv_scale_get_range_min_value = Module['_lv_scale_get_range_min_value'] = createExportWrapper('lv_scale_get_range_min_value');
var _lv_scale_get_range_max_value = Module['_lv_scale_get_range_max_value'] = createExportWrapper('lv_scale_get_range_max_value');
var _lv_slider_is_dragged = Module['_lv_slider_is_dragged'] = createExportWrapper('lv_slider_is_dragged');
var _lv_slider_set_value = Module['_lv_slider_set_value'] = createExportWrapper('lv_slider_set_value');
var _lv_slider_set_left_value = Module['_lv_slider_set_left_value'] = createExportWrapper('lv_slider_set_left_value');
var _lv_slider_set_range = Module['_lv_slider_set_range'] = createExportWrapper('lv_slider_set_range');
var _lv_slider_set_mode = Module['_lv_slider_set_mode'] = createExportWrapper('lv_slider_set_mode');
var _lv_slider_get_value = Module['_lv_slider_get_value'] = createExportWrapper('lv_slider_get_value');
var _lv_slider_get_left_value = Module['_lv_slider_get_left_value'] = createExportWrapper('lv_slider_get_left_value');
var _lv_slider_get_min_value = Module['_lv_slider_get_min_value'] = createExportWrapper('lv_slider_get_min_value');
var _lv_slider_get_max_value = Module['_lv_slider_get_max_value'] = createExportWrapper('lv_slider_get_max_value');
var _lv_slider_get_mode = Module['_lv_slider_get_mode'] = createExportWrapper('lv_slider_get_mode');
var _lv_slider_is_symmetrical = Module['_lv_slider_is_symmetrical'] = createExportWrapper('lv_slider_is_symmetrical');
...
var _lv_spangroup_get_max_line_height = Module['_lv_spangroup_get_max_line_height'] = createExportWrapper('lv_spangroup_get_max_line_height');
...
var _lv_spangroup_delete_span = Module['_lv_spangroup_delete_span'] = createExportWrapper('lv_spangroup_delete_span');
...
var _lv_spangroup_set_max_lines = Module['_lv_spangroup_set_max_lines'] = createExportWrapper('lv_spangroup_set_max_lines');
var _lv_span_get_style = Module['_lv_span_get_style'] = createExportWrapper('lv_span_get_style');
var _lv_spangroup_get_child = Module['_lv_spangroup_get_child'] = createExportWrapper('lv_spangroup_get_child');
var _lv_spangroup_get_span_count = Module['_lv_spangroup_get_span_count'] = createExportWrapper('lv_spangroup_get_span_count');
...
var _lv_spangroup_get_max_lines = Module['_lv_spangroup_get_max_lines'] = createExportWrapper('lv_spangroup_get_max_lines');
...
var _lv_spinner_set_anim_params = Module['_lv_spinner_set_anim_params'] = createExportWrapper('lv_spinner_set_anim_params');
...
var _lv_table_set_column_count = Module['_lv_table_set_column_count'] = createExportWrapper('lv_table_set_column_count');
var _lv_table_set_row_count = Module['_lv_table_set_row_count'] = createExportWrapper('lv_table_set_row_count');
var _lv_table_set_cell_value_fmt = Module['_lv_table_set_cell_value_fmt'] = createExportWrapper('lv_table_set_cell_value_fmt');
var _lv_table_set_column_width = Module['_lv_table_set_column_width'] = createExportWrapper('lv_table_set_column_width');
...
var _lv_table_set_selected_cell = Module['_lv_table_set_selected_cell'] = createExportWrapper('lv_table_set_selected_cell');
var _lv_table_get_cell_value = Module['_lv_table_get_cell_value'] = createExportWrapper('lv_table_get_cell_value');
var _lv_table_get_row_count = Module['_lv_table_get_row_count'] = createExportWrapper('lv_table_get_row_count');
var _lv_table_get_column_count = Module['_lv_table_get_column_count'] = createExportWrapper('lv_table_get_column_count');
var _lv_table_get_column_width = Module['_lv_table_get_column_width'] = createExportWrapper('lv_table_get_column_width');
...
var _lv_tabview_get_tab_count = Module['_lv_tabview_get_tab_count'] = createExportWrapper('lv_tabview_get_tab_count');
var _lv_tabview_set_tab_bar_size = Module['_lv_tabview_set_tab_bar_size'] = createExportWrapper('lv_tabview_set_tab_bar_size');
var _lv_tabview_get_tab_active = Module['_lv_tabview_get_tab_active'] = createExportWrapper('lv_tabview_get_tab_active');
...
var _lv_textarea_delete_char_forward = Module['_lv_textarea_delete_char_forward'] = createExportWrapper('lv_textarea_delete_char_forward');
...
var _lv_textarea_get_current_char = Module['_lv_textarea_get_current_char'] = createExportWrapper('lv_textarea_get_current_char');
...
var _lv_tileview_set_tile = Module['_lv_tileview_set_tile'] = createExportWrapper('lv_tileview_set_tile');
var _lv_tileview_set_tile_by_index = Module['_lv_tileview_set_tile_by_index'] = createExportWrapper('lv_tileview_set_tile_by_index');
var _lv_tileview_get_tile_active = Module['_lv_tileview_get_tile_active'] = createExportWrapper('lv_tileview_get_tile_active');
