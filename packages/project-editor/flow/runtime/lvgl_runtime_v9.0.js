...
var ASM_CONSTS = {
  1040880: ($0) => { startToDebuggerMessage($0); },  
 1040912: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1040987: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1041062: ($0) => { finishToDebuggerMessage($0); },  
 1041095: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1041125: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1041155: ($0) => { lvglScreenTick($0); },  
 1041179: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1041219: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1041273: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1041327: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1041380: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1041433: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1041486: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1041519: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1041555: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1041600: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1041706: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1041742: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1041779: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1041819: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1041876: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1041935: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
