...
var ASM_CONSTS = {
  1030392: ($0) => { startToDebuggerMessage($0); },  
 1030424: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1030499: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1030574: ($0) => { finishToDebuggerMessage($0); },  
 1030607: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1030660: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1030766: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1030802: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1030839: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1030879: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1030936: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1030995: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
