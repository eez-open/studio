...
var ASM_CONSTS = {
  1175800: ($0) => { startToDebuggerMessage($0); },  
 1175832: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1175907: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1175982: ($0) => { finishToDebuggerMessage($0); },  
 1176015: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1176045: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1176075: ($0) => { lvglScreenTick($0); },  
 1176099: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1176139: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1176193: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1176247: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1176300: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1176353: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1176406: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1176458: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1176505: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1176538: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1176574: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1176619: ($0, $1) => { js_dispatch_event($0, $1); },  
 1176650: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1176756: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1176792: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1176829: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1176869: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1176926: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1176985: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
