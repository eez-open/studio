...
var ASM_CONSTS = {
  1172760: ($0) => { startToDebuggerMessage($0); },  
 1172792: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1172867: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1172942: ($0) => { finishToDebuggerMessage($0); },  
 1172975: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1173005: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1173035: ($0) => { lvglScreenTick($0); },  
 1173059: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1173099: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1173153: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1173207: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1173260: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1173313: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1173366: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1173418: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1173465: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1173498: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1173534: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1173579: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1173685: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1173721: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1173758: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1173798: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1173855: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1173914: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
