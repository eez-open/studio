...
var ASM_CONSTS = {
  1199608: ($0) => { startToDebuggerMessage($0); },  
 1199640: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1199715: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1199790: ($0) => { finishToDebuggerMessage($0); },  
 1199823: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1199853: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1199883: ($0) => { lvglScreenTick($0); },  
 1199907: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1199947: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1200001: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1200055: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1200108: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1200161: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1200214: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1200266: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1200313: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1200346: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1200382: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1200427: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1200533: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1200569: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1200606: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1200646: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1200703: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1200762: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
