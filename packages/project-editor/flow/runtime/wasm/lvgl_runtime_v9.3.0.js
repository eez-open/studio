...
var ASM_CONSTS = {
  1175392: ($0) => { startToDebuggerMessage($0); },  
 1175424: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1175499: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1175574: ($0) => { finishToDebuggerMessage($0); },  
 1175607: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1175637: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1175667: ($0) => { lvglScreenTick($0); },  
 1175691: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1175731: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1175785: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1175839: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1175892: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1175945: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1175998: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1176045: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1176078: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1176114: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1176159: ($0, $1) => { js_dispatch_event($0, $1); },  
 1176190: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1176296: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1176332: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1176369: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1176409: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1176466: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1176525: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
