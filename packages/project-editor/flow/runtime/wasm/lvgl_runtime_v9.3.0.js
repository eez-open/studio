...
var ASM_CONSTS = {
  1059408: ($0) => { startToDebuggerMessage($0); },  
 1059440: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1059515: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1059590: ($0) => { finishToDebuggerMessage($0); },  
 1059623: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1059653: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1059683: ($0) => { lvglScreenTick($0); },  
 1059707: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1059747: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1059801: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1059855: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1059908: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1059961: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1060014: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1060047: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1060083: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1060128: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1060234: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1060270: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1060307: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1060347: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1060404: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1060463: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
