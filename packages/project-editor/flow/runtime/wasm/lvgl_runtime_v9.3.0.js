...
var ASM_CONSTS = {
  1175736: ($0) => { startToDebuggerMessage($0); },  
 1175768: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1175843: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1175918: ($0) => { finishToDebuggerMessage($0); },  
 1175951: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1175981: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1176011: ($0) => { lvglScreenTick($0); },  
 1176035: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1176075: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1176129: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1176183: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1176236: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1176289: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1176342: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1176394: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1176441: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1176474: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1176510: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1176555: ($0, $1) => { js_dispatch_event($0, $1); },  
 1176586: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1176692: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1176728: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1176765: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1176805: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1176862: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1176921: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
