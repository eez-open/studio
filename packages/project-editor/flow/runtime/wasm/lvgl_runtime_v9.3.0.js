...
var ASM_CONSTS = {
  1199928: ($0) => { startToDebuggerMessage($0); },  
 1199960: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1200035: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1200110: ($0) => { finishToDebuggerMessage($0); },  
 1200143: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1200173: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1200203: ($0) => { lvglScreenTick($0); },  
 1200227: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1200267: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1200321: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1200375: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1200428: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1200481: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1200534: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1200586: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1200633: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1200666: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1200702: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1200747: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1200853: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1200889: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1200926: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1200966: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1201023: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1201082: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
