...
var ASM_CONSTS = {
  1182696: ($0) => { startToDebuggerMessage($0); },  
 1182728: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1182803: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1182878: ($0) => { finishToDebuggerMessage($0); },  
 1182911: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1182941: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1182971: ($0) => { lvglScreenTick($0); },  
 1182995: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1183035: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1183089: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1183143: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1183196: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1183249: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1183302: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1183354: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1183401: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1183434: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1183470: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1183515: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1183621: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1183657: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1183694: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1183734: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1183791: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1183850: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
