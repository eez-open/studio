...
var ASM_CONSTS = {
  1182376: ($0) => { startToDebuggerMessage($0); },  
 1182408: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1182483: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1182558: ($0) => { finishToDebuggerMessage($0); },  
 1182591: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1182621: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1182651: ($0) => { lvglScreenTick($0); },  
 1182675: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1182715: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1182769: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1182823: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1182876: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1182929: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1182982: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1183034: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1183081: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1183114: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1183150: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1183195: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1183301: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1183337: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1183374: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1183414: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1183471: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1183530: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
