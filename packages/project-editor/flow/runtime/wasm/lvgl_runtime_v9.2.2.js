...
var ASM_CONSTS = {
  1158520: ($0) => { startToDebuggerMessage($0); },  
 1158552: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1158627: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1158702: ($0) => { finishToDebuggerMessage($0); },  
 1158735: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1158765: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1158795: ($0) => { lvglScreenTick($0); },  
 1158819: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1158859: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1158913: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1158967: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1159020: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1159073: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1159126: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1159178: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1159225: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1159258: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1159294: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1159339: ($0, $1) => { js_dispatch_event($0, $1); },  
 1159370: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1159476: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1159512: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1159549: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1159589: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1159646: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1159705: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
