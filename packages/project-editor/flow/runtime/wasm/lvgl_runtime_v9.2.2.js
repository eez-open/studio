...
var ASM_CONSTS = {
  1155512: ($0) => { startToDebuggerMessage($0); },  
 1155544: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1155619: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1155694: ($0) => { finishToDebuggerMessage($0); },  
 1155727: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1155757: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1155787: ($0) => { lvglScreenTick($0); },  
 1155811: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1155851: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1155905: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1155959: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1156012: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1156065: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1156118: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1156170: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1156217: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1156250: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1156286: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1156331: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1156437: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1156473: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1156510: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1156550: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1156607: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1156666: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
