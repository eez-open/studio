...
var ASM_CONSTS = {
  1185552: ($0) => { startToDebuggerMessage($0); },  
 1185584: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1185659: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1185734: ($0) => { finishToDebuggerMessage($0); },  
 1185767: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1185797: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1185827: ($0) => { lvglScreenTick($0); },  
 1185851: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1185891: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1185945: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1185999: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1186052: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1186105: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1186158: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1186210: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1186257: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1186290: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1186326: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1186371: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1186477: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1186513: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1186550: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1186590: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1186647: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1186706: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
