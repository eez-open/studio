...
var ASM_CONSTS = {
  1209568: ($0) => { startToDebuggerMessage($0); },  
 1209600: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1209675: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1209750: ($0) => { finishToDebuggerMessage($0); },  
 1209783: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1209813: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1209843: ($0) => { lvglScreenTick($0); },  
 1209867: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1209907: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1209961: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1210015: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1210068: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1210121: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1210174: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1210226: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1210273: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1210306: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1210342: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1210387: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1210493: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1210529: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1210566: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1210606: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1210663: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1210722: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
