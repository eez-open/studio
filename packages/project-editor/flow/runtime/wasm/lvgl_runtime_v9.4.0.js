...
var ASM_CONSTS = {
  1206208: ($0) => { startToDebuggerMessage($0); },  
 1206240: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1206315: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1206390: ($0) => { finishToDebuggerMessage($0); },  
 1206423: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1206453: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1206483: ($0) => { lvglScreenTick($0); },  
 1206507: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1206547: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1206601: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1206655: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1206708: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1206761: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1206814: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1206866: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1206913: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1206946: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1206982: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1207027: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1207133: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1207169: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1207206: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1207246: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1207303: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1207362: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
