...
var ASM_CONSTS = {
  1064112: ($0) => { startToDebuggerMessage($0); },  
 1064144: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1064219: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1064294: ($0) => { finishToDebuggerMessage($0); },  
 1064327: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1064357: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1064387: ($0) => { lvglScreenTick($0); },  
 1064411: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1064451: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1064505: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1064559: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1064612: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1064665: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1064718: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1064751: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1064787: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1064832: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1064938: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1064974: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1065011: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1065051: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1065108: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1065167: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
