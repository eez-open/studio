...
var ASM_CONSTS = {
  1177416: ($0) => { startToDebuggerMessage($0); },  
 1177448: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1177523: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1177598: ($0) => { finishToDebuggerMessage($0); },  
 1177631: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1177661: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1177691: ($0) => { lvglScreenTick($0); },  
 1177715: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1177755: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1177809: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 1177863: ($0, $1) => { return getLvglGroupByName($0, UTF8ToString($1)); },  
 1177916: ($0, $1) => { return getLvglStyleByName($0, UTF8ToString($1)); },  
 1177969: ($0, $1) => { return getLvglImageByName($0, UTF8ToString($1)); },  
 1178022: ($0, $1) => { return getLvglFontByName($0, UTF8ToString($1)); },  
 1178074: ($0, $1) => { return getLvglObjectNameFromIndex($0, $1); },  
 1178121: ($0, $1, $2) => { lvglObjAddStyle($0, $1, $2); },  
 1178154: ($0, $1, $2) => { lvglObjRemoveStyle($0, $1, $2); },  
 1178190: ($0, $1) => { lvglSetColorTheme($0, UTF8ToString($1)); },  
 1178235: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1178341: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1178377: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1178414: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1178454: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1178511: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1178570: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
